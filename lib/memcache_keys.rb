module MemcacheKeys
  ...
  ACCOUNT_CUSTOM_FILE_FIELD_NAMES = 'v1/ACCOUNT_CUSTOM_FILE_FIELD_NAMES:%{account_id}'.freeze
  ...
  ACCOUNT_TICKET_FIELDS_NAME_TYPE_MAPPING = 'v2/ACCOUNT_TICKET_FIELDS_NAME_TYPE_MAPPING:%{account_id}'.freeze
