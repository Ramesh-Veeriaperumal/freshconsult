module RabbitMq::Subscribers::Tickets::AutoRefresh
  ...
  def mq_auto_refresh_subscriber_properties(_action)
    {
  ...
  private
    ...
    def ticket_properties_changes_hash
      ...
      if misc_changes.present?
        changes[:tag_names] = [misc_changes[:add_tag], misc_changes[:remove_tag]].flatten.uniq.compact
      end
