...
module HelpdeskActivities
  ...
  class ActivityExportRequest
    ...
    FIELDS = {
      ACCOUNT_ID => {:type => ::Thrift::Types::I64, :name => 'account_id'},
      DATE => {:type => ::Thrift::Types::STRING, :name => 'date', :optional => true}
    }
  ...
  class ActivityExportResponse
    ...
    FIELDS = {
      ...
      FILE_URL => {:type => ::Thrift::Types::STRING, :name => 'file_url', :optional => true},
      ERROR_MESSAGE => {:type => ::Thrift::Types::STRING, :name => 'error_message', :optional => true}
    }
  ...
  class TicketActivityExportException < ::Thrift::Exception
    include ::Thrift::Struct, ::Thrift::Struct_Union
    def initialize(message=nil)
      super()
      self.message = message
