  ...
  module Redis::ClientPatch
    Redis::Client.class_eval do
      ...
      def process(commands)
        ...
        return res unless options[:retry_password]
        ...
        raise e unless options[:retry_password]
      ...
      private
        ...
        def reconnect_with_opts
          retry_options = {}
          retry_options[:password] = options[:retry_password] if options[:retry_password]
