module Redis::Keys::Others
  ...
  AUTO_RESPONSE_DETECTOR_ENABLED = 'AUTO_RESPONSE_DETECTOR_ENABLED'.freeze

  # TODO: Freshchat/Freshcaller worker delay key
  # can be removed later once stable
  OMNI_CHANNEL_FRESHCALLER_API_DELAY_TIME = 'OMNI_CHANNEL_FRESHCALLER_API_DELAY_TIME'.freeze
  OMNI_CHANNEL_FRESHCHAT_API_DELAY_TIME = 'OMNI_CHANNEL_FRESHCHAT_API_DELAY_TIME'.freeze
end
