module Redis::Keys::Others
  ...
  FREE_ACCOUNT_30_DAYS_THRESHOLD          = "FREE_ACCOUNT_30_DAYS_THRESHOLD".freeze
  ...
  SEARCH_SERVICE_COUNT_ES_WRITES_ENABLED   = "SEARCH_SERVICE_COUNT_ES_WRITES_ENABLED".freeze
  SEARCH_SERVICE_COUNT_ES_READS_ENABLED    = "SEARCH_SERVICE_COUNT_ES_READS_ENABLED".freeze
  # IMPORT keys
  CONTACT_IMPORT_TOTAL_RECORDS             = "CONTACT_IMPORT_TOTAL_RECORDS:%{account_id}".freeze
  CONTACT_IMPORT_FINISHED_RECORDS          = "CONTACT_IMPORT_FINISHED_RECORDS:%{account_id}".freeze
  COMPANY_IMPORT_TOTAL_RECORDS             = "COMPANY_IMPORT_TOTAL_RECORDS:%{account_id}".freeze
  COMPANY_IMPORT_FINISHED_RECORDS          = "COMPANY_IMPORT_FINISHED_RECORDS:%{account_id}".freeze
  STOP_CONTACT_IMPORT                      = "STOP_CONTACT_IMPORT:%{account_id}".freeze
  STOP_COMPANY_IMPORT                      = "STOP_COMPANY_IMPORT:%{account_id}".freeze
