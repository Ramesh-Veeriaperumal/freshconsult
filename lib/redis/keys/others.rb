module Redis::Keys::Others
  ...
  NEW_2020_PRICING_ENABLED = 'NEW_2020_PRICING_ENABLED'.freeze
  NEW_2020_PRICING_TEST_USERS = 'NEW_2020_PRICING_TEST_USERS'.freeze
  ...
  FRESHID_MIGRATION_ENABLED_ACCOUNT_FRESHOPS = 'FRESHID_MIGRATION_ENABLED_ACCOUNT_FRESHOPS'.freeze
end
