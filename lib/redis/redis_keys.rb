module Redis::RedisKeys
  ...
  ACCOUNT_RELATED_KEYS = [
    ...
    GROUP_WIDGET_CACHE_GET, AGENT_LANGUAGE_LIST, CUSTOMER_LANGUAGE_LIST, OUTGOING_COUNT_PER_HALF_HOUR, OUTBOUND_EMAIL_COUNT_PER_DAY, YEAR_IN_REVIEW_CLOSED_USERS, YEAR_IN_REVIEW_ACCOUNT, ACTIVE_SUSPENDED, BACKGROUND_FIXTURES_STATUS,
    ACCOUNT_CANCELLATION_REQUEST_JOB_ID, ACCOUNT_CANCELLATION_REQUEST_TIME
  ].freeze
  ...
  ACCOUNT_USER_KEYS = [
    ...
    SOLUTION_DRAFTS_SCOPE, GAMIFICATION_QUEST_COOLDOWN, PERSISTENT_RECENT_TICKETS, SUPPORT_TICKET_LIMIT
  ].freeze
