module TicketsFilter
  ...
  DEFAULT_VISIBLE_FILTERS = %w( ongoing_collab new_and_my_open shared_by_me shared_with_me unresolved all_tickets raised_by_me monitored_by archived spam deleted )
