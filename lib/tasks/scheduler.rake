...
namespace :scheduler do
  ...
  PREMIUM_ACCOUNT_IDS_FB = {
      "development" => [1],
      "staging"     => [390], 
      "production"  => [79003, 309357, 39190, 19063, 86336, 34388, 126077, 220561, 166928, 254067, 381984, 470840, 558611, 398354]
  }

  PREMIUM_ACCOUNT_IDS_TWT = {
    "development" => [1],
    "staging"     => [390], 
    "production"  => [79003, 309357, 39190, 19063, 86336, 34388, 126077, 220561, 166928, 254067, 381984, 558611, 398354]
  }
