module Integrations::CloudElements::Crm
  module SalesforceV2::Constant
    ...
    SALESFORCE_V2 = {
      ...
      "element_name" => "salesforce",
      "account_name_format" => "Id",
      ...
      "default_visibility_fields" => {"contact"=> ["Name"], "account" => ["Name"], "lead" => ["Name"], "opportunity"=> ["Name", "StageName", "CloseDate"], "contract"=> ["ContractNumber","StartDate", "ContractTerm", "Status"], "order"=> ["OrderNumber","EffectiveDate", "TotalAmount"]}, #default view fields
        "default_visibility_labels" => {"contact"=> ["Full Name"], "account"=> ["Account Name"], "lead"=> ["Full Name"], "opportunity"=> ["Name", "Stage", "Close Date"], "contract"=> ["Contract Number","Contract Start Date", "Contract Term", "Status"], "order"=> ["Order Number","Order Start Date", "Order Amount"]}, #default view labels
      "delete_fields"=>{"contact_fields"=>["FDCONTACTID__c", "Id", "IsDeleted", "AccountId", "MasterRecordId", "ReportsToId", "OwnerId", "LastModifiedById", "CreatedById", "IsEmailBounced", "JigsawContactId"], 
                        ...
                        "account_fields_types"=>["FDACCOUNTID", "Account ID", "Deleted", "Master Record ID", "Parent Account ID", "Owner ID", "Created By ID", "Jigsaw Company ID"]}, #Custom fields that should not be synced by the User(We will use these fields for sync).
