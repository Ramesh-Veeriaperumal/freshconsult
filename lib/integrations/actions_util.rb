module Integrations
  class ActionsUtil
    ...
    def office365 installed_app, condition
      { :name => "Integrations::Office365ActionHandler", :value => "#{I18n.t('integrations.office365.message.push_to_outlook')}", :domtype => 'office365', :condition => condition[:dispatcher] || condition[:observer] 
      }
    end
