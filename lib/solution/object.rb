class Solution::Object
	...
	META_ATTRIBUTES = {
        ...
        :solution_folder => [:visibility, :is_default, :customer_folders_attributes, :article_order, :contact_folders_attributes, :company_folders_attributes],
	...
	VERSION_ATTRIBUTES = {
		...
		solution_article: [:title, :description, :user_id, :status, :import_id, :seo_data, :outdated, :thumbs_up, :thumbs_down, :suggested]
	}
