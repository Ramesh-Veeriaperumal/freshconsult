class SAAS::SubscriptionEventActions
  ...
  DROP_DATA_FEATURES_V2 = [:create_observer, :supervisor, :add_watcher, :custom_ticket_views, :custom_apps,
                           ...
                           :auto_ticket_export, :multiple_companies_toggle, :unique_contact_identifier, :support_bot, :custom_dashboard, :freshconnect]

  ADD_DATA_FEATURES_V2  = [:link_tickets_toggle, :parent_child_tickets_toggle, :multiple_companies_toggle,
                           :tam_default_fields, :smart_filter, :contact_company_notes, :unique_contact_identifier, :custom_dashboard, :freshconnect].freeze
