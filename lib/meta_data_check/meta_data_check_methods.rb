module MetaDataCheck::MetaDataCheckMethods
  ...
  def self.check_route53(account)
    begin
      response = $route53.list_resource_record_sets(hosted_zone_id: PodDnsUpdate::DNS_CONFIG['hosted_zone'], start_record_name: account['full_domain'], start_record_type: 'CNAME', max_items: 1)
