...
class EhawkEmailVerifier
  ...
  def check_activity_status
    ...
    @api_response["reason"] << @api_response["activity_details"] if activity_status >= 4
  ...
  def check_community_status
    ...
    @api_response["reason"] << @api_response["community_details"] if community_status >= 4
  ...
  def check_email_status
  	...
  	@api_response["reason"] << @api_response["email_details"] if email_status >= 4
  ...
  def check_ip_status
    ip_status = risk_status @api_response["ip_score"]
  	@api_response["reason"] << @api_response["ip_details"] if ip_status >= 4
