...
class Middleware::ApiThrottler < Rack::Throttle::Hourly
  ...
  SKIPPED_SUBDOMAINS = ["admin", "billing", "signup", "email","login", "emailparser", "mailboxparser","freshops"] + FreshopsSubdomains + PartnerSubdomains
  SKIPPED_PATHS      = ["/reports/v2","/reports","/suggest/tickets", "/sentiment_feedback", "/freshid/event_callback", "/mkp/data-pipe"]
