...
class Middleware::CorsEnabler < Rack::Cors
  ...
  CORS_RESOURCE_CONFIG = {
    ...
    :expose => ['X-Path', 'X-Method', 'X-Query-String', 'X-Ua-Compatible', 'X-Meta-Request-Version', 'X-Request-Id', 'X-Runtime', 'X-RateLimit-Total', 'X-RateLimit-Remaining', 'X-RateLimit-Used-CuurentRequest', 'X-Freshdesk-API-Version'] 
