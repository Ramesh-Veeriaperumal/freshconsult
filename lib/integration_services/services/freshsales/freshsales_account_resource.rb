module IntegrationServices::Services
  module Freshsales
    class FreshsalesAccountResource < FreshsalesResource
      ...
      def get_selected_fields fields, value
        return { "sales_accounts" => [], "type" => "sales_account" } if value[:company].blank? and value[:email].blank?
        ...
        return { "sales_accounts" => [], "type" => "sales_account" } if account_response.blank? or account_response["sales_accounts"].blank?
