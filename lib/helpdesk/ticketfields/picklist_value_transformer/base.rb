class Helpdesk::Ticketfields::PicklistValueTransformer::Base
  ...
  private
    ...
    def ticket_field_by_flexifield_name_hash
      @ticket_field_by_flexifield_name_hash ||= Hash.new.tap do |h|
    ...
    def ticket_fields
      @ticket_fields ||= account.ticket_fields_from_cache.select { |ticket_field| ticket_field.field_type == 'custom_dropdown' || ticket_field.field_type == 'nested_field' }
    end
