module Helpdesk::TicketModelExtension
  ...
  EXPORT_FIELDS = [
    ...
    [ "export_data.fields.due_by_time",           "due_by",                  false,  nil              , 16    , "sla_management_v2_enabled?"],
    [ "export_data.fields.initial_response_time", "first_response_time",     false,  :ticket_states   , 20    , "sla_management_v2_enabled?"],
    [ "export_data.fields.fr_time",               "first_res_time_bhrs",     false,  :ticket_states   , 22    , "sla_management_v2_enabled?"],
    [ "export_data.fields.resolution_time",       "resolution_time_bhrs",    false,  :ticket_states   , 23    , "sla_management_v2_enabled?"],
    [ "export_data.fields.resolution_status",     "resolution_status",       false,  :ticket_states   , 26    , "sla_management_v2_enabled?"],
    [ "export_data.fields.first_response_status", "first_response_status",   false,  :ticket_states   , 27    , "sla_management_v2_enabled?"],
