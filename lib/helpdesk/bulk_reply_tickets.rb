class Helpdesk::BulkReplyTickets
  ...
  def cleanup!
    ...
    attachments_to_be_destroyed = fetch_attachment_records.collect(&:id) + fetch_inline_attachment_records.collect(&:id)
  ...
  private
    ...
    def twitter_reply ticket, note
      ...
      safe_send("send_tweet_as_#{twt_type}", ticket, note, tweet_body) unless error_message
    end
