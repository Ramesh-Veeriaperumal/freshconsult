...
$redis_tickets = Redis.new(:host => config["host"], :port => config["port"], :timeout => 2)
$redis_reports = Redis.new(:host => config["host"], :port => config["port"], :timeout => 2)
$redis_integrations = Redis.new(:host => config["host"], :port => config["port"], :timeout => 2)
$redis_portal = Redis.new(:host => config["host"], :port => config["port"], :timeout => 2)
$redis_others = Redis.new(:host => config["host"], :port => config["port"], :timeout => 2)
...
$redis_routes = Redis.new(:host => routes_config["host"], :port => routes_config["port"], :timeout => 2)
$redis_display_id = Redis.new(:host => display_id_config["host"], :port => display_id_config["port"], :timeout => 2)
