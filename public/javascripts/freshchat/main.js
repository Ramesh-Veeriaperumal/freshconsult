(function(){
	...
	var chat_loaded_callback = function(archiveCollection, visitor_collection){
		...
		var archiveRouter = window.freshChat.archiveRouter();
		var archiveView = window.freshChat.archiveView();
		var conversationView = window.freshChat.conversationView();
		var routerInstance = new archiveRouter({
			archiveCollection : archiveCollection,
			archiveView : archiveView,
			conversationView : conversationView,
			visitorListView : window.freshChat.visitor_list_view(),
			visitor_collection : visitor_collection
		});
		...
		window.freshChat.archiveRouter = null;
		window.freshChat.archiveView = null;
		window.freshChat.conversationView = null;
	...
	*/
	if(window.freshChat && window.freshChat.archiveCollection){
		chat_loaded_callback(window.freshChat.archiveCollection,window.freshChat.visitor_collection);
	}else{
