...
(function($) {
  ...
  App.Admin.Skills.Edit = {
    ...
    //Innitial Construct modal used during Edit
    getExistingList: function() {
      var _this = this;
      var Skill_id = $('a.popup').data('skillid');
      $.ajax({
        url: '/admin/skills/' + Skill_id + '/users',
        type: 'GET',
        dataType: 'json',
        success: function(data) {
          _this.agentTemplate(data);
    ...
    bindEvents: function() {
      ...
      $doc.on('click.skills', 'a.popup', function() {
        var data = $(this).data();
        _this._showPopup(data.skillid, data.title, data.agentcount, data.isaccadmin);
    ...
    //  * [_showPopup Displays the Popup Modal for Add Agents]
    ...
    _showPopup: function(id, name, agentcount, isaccadmin) {
      var _this = this;
