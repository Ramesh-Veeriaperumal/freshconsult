...
(function($){
	...
	BarChart.prototype = {
		...
		renderNoData: function() {
			...
			$(this.options.renderTo).append("<div class='no_data_to_display text-center muted mt20'><i class='ficon-no-data fsize-72'></i><div class='mt10'>" + I18n.t('no_date_to_display')+ "</div></div>");
		},
		destroy: function () {
			delete this.group;
