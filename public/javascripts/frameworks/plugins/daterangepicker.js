    ...
    BootstrapDateRangePicker.prototype = {
        ...
        updateInputText: function() {
            if (this.element.is('input') && !this.singleDatePicker) {
                var input_start_date = moment(this.startDate);
                var input_end_date = moment(this.endDate);
                this.element.val(input_start_date.lang(this.displaylocale).format(this.format) + this.separator + input_end_date.lang(this.displaylocale).format(this.format));
        ...
        clickDate: function (e) {
            ...
            this.element.trigger('clickdate',this)
        },
        ...
        updateCalendars: function () {
            ...
            this.container.find('.calendar.left tbody td').prop("title","From");
            this.container.find('.calendar.right tbody td').prop("title","To");
