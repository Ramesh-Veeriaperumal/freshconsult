   ...
   */
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            this.body = $(opts.attachtoContainerClass) // $("body");
        ...
        updateResults: function (initial) {
            ...
            function postRender() {
                ...
                // TODO MERGE modified code
                if (isEmpty(self.results.find("li"))) {
                  self.dropdown.hide();
                }
            }
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   <div class='select2-arrow' role='presentation'><b role='presentation'></b></div>",
                "</a>",
        ...
        initContainer: function () {
            ...
            this.search.on("keydown", this.bind(function (e) {
                ...
                if (selected.length &&
                    ...
                    else if (this.opts.removeOptionOnBackspace && e.which === KEY.BACKSPACE) {
    ...
    $.fn.select2.locales['en'] = {
         ...
         formatInputTooShort: function (input, min) { var n = min - input.length; return "Please enter " + n + " or more characters"; },
