  ...
  $.FE.PLUGINS.imageManager = function (editor) {
    ...
    function show () {
      ...
      if (!$modal) {
        ...
        // Build head.
        var head = '<div class="fr-modal-head-line fr-modal-title-line"><i class="fa fa-bars fr-modal-more fr-not-available" id="fr-modal-more-' + editor.sid + '" title="' + editor.language.translate('Tags') + '"></i><h4 data-text="true">' + editor.language.translate('Manage Images') + '</h4><i title="' + editor.language.translate('Cancel') + '" id="fr_modal_close" class="fr_modal_close fr-modal-close"></i></div>';
