...
var SurveyRemark = {
        ...
        renderContent:function(data,isPageless){
            if(!SurveyReport.isEmptyChart()){
                ...
                var remarkHTML = JST["survey/analytics/template/content_response_layout"]({remarks:remarks});
        ...
        renderFilterBy:function(){
            jQuery('#survey_report_filter_by_component').html(JST["survey/analytics/template/filter_by_component"]());
