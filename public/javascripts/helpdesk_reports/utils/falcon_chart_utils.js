REPORT_COLORS = {
    ...
    series_colors    : ['#239cff', '#a0d76a', '#ffd012'],
    ...
    bucket_series    : ['#a0d76a', '#239cff'],
    stack_color      : {
                        'received': ["#F5F5F5", "#239cff"],
                        'resolved': ["#F5F5F5", "#a0d76a", "#C1D8A8"],
                        'unresolved': ["#F5F5F5", "#ffd012", "rgba(247,208,144,1)"]
                       },
    stack_data       : "white"
}
    ...
    stackedColumnChartTooltip: function(){
        ...
        if(CURRENT_STACKED_CHART_TYPE == 'received'){
             if(this.points[1] != undefined) {
                 msg += '<p style="margin:0;color:#239cff;font-size: 13px;font-weight: 500">' + I18n.t('helpdesk_reports.chart_title.new_received') + ' : ' + this.points[1].y + ' <span style="color:#239cff;font-size: 13px;font-weight: 500"> (' + (Math.round((this.points[1].y/this.points[0].y)*100) || 0) + '%)</span></p><div/>';
             }
        }
        else if(CURRENT_STACKED_CHART_TYPE == 'resolved'){
            msg += '<p style="margin:0;color:#a0d76a;font-size: 13px;font-weight: 500">' + I18n.t('helpdesk_reports.chart_title.all_resolved') + ' : ' + this.points[1].y + ' <span style="color:#a0d76a;font-size: 13px;font-weight: 500"> (' + (Math.round((this.points[1].y/this.points[0].y)*100) || 0) + '%)</span></p>';
