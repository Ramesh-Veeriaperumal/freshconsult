    ...
    logBasicInformation: function () {
      ...
      basic_info = { 
        ...
        'freshfone calls' : {
         ...
         'freshfone socket' : {
            "Connected_at" : freshfonesocket.connectionCreatedAt.toString(),
            "Disconnected_at" : freshfonesocket.connectionClosedAt.toString()
         },
        'Flash version' : flashVersion,
        'Tab Id / Tab Count': this.tabId + " / " + this.tabs_count,
        'Net Connected At' : this.lastestNetConnectedAt,
        'Net Disconnected At': this.lastestNetDisconnectedAt
      };
      return basic_info;
    },
