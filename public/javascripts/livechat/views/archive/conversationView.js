...
window.liveChat.conversationView = function(){
		return Backbone.View.extend({
			initialize :function(options){
				...
				this.visitorTemplate = window.JST["livechat/templates/archive/visitorDetails"] ;
				this.conversationTemplate = window.JST["livechat/templates/archive/conversation"];
			},
			events :{
