...
FreshbooksWidget.prototype = {
	...
	mergePagedProjects: function(resData) {
		try{
			...
			projectPattern =  '<projects page="' + this.curr_page + '" per_page="10" pages="' + this.tot_pages + '" total="' + this.tot_items + '">';
