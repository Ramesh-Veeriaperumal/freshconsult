   ...
   populateAgentsByGroups: function(group_id){  
    ...
    addAgentByPresence: function (id) {
        ...
        if (this.agent.presence==this.Status.ONLINE|| 
          (this.agent.presence==this.Status.BUSY&&this.agent.preference==this.Preference.TRUE)||
          this.agent.on_phone){
           if(this.agent.preference==this.Preference.TRUE||this.agent.on_phone){
        ...
        if ((this.agent.presence==this.Status.OFFLINE|| 
          (this.agent.presence==this.Status.BUSY&&this.agent.preference==this.Preference.FALSE))&&
          (!this.agent.on_phone)){
