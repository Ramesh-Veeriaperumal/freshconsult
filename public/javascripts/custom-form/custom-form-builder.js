(function($) {
  ...
  fsm_fields = ["cf_fsm_contact_name", "cf_fsm_phone_number", "cf_fsm_service_location", "cf_fsm_appointment_start_time", "cf_fsm_appointment_end_time", "cf_fsm_customer_signature"].map(function(field){ return (field + "_" + current_account_id); });
