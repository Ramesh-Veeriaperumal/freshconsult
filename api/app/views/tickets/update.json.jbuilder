...
json.(@ticket, :description, :description_html, :fr_escalated, :spam, :urgent, :email_config_id, :fr_escalated, :group_id, :priority, :requester_id, :responder_id, :source, :status, :subject, :to_email, :to_emails, :product_id, :attachments)
