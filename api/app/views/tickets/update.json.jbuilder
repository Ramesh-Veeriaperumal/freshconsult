...
json.(@ticket, :description, :description_html, :display_id, :fr_escalated, :spam, :urgent, :requester_status_name, :email_config_id, :fr_escalated, :group_id, :priority, :requester_id, :responder_id, :source, :status, :subject, :ticket_type, :to_email, :to_emails, :product_id, :attachments)
