...
json.(@item, :description, :description_html, :fr_escalated, :spam, :urgent, :email_config_id, :group_id, :priority, :requester_id, :responder_id, :source, :status, :subject, :to_email)
