...
json.(@ticket, :description, :description_html, :fr_escalated, :spam, :urgent, :requester_status_name, :email_config_id, :group_id, :priority, :requester_id, :responder_id, :source, :status, :subject, :to_email, :to_emails, :product_id)
