json.(@item, :active, :address, :company_id, :description, :email, :fb_profile_id, :helpdesk_agent, :id, :job_title, :language, :mobile, :name, :phone, :time_zone, :twitter_id, :client_manager)
