module ApiSolutions::DraftConstants
  ...
  INDEX_FIELDS = %w[portal_id language].freeze
  AUTOSAVE_FIELDS = %w[title description timestamp session].freeze
  UPDATE_FIELDS = %w[title description user_id modified_at last_updated_at session approval_data].freeze
