module ConversationConstants
  ...
  LOAD_OBJECT_EXCEPT = [:ticket_conversations, :reply, :forward].freeze
  ...
  FORWARD_FIELD_MAPPINGS = { user: :agent_id }

  PARAMS_MAPPINGS = { notify_emails: :to_emails, agent_id: :user_id }

  TICKET_LOAD_REQUIRED = [:create, :reply, :forward, :ticket_conversations].freeze
end.freeze
