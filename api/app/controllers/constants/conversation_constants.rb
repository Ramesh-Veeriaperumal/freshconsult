module ConversationConstants
  ...
  TWEET_FIELDS = %w(body tweet_type twitter_handle_id last_note_id attachment_ids).freeze
  ...
  PARAMS_TO_SAVE_AND_REMOVE = [:note_id, :cloud_files, :attachment_ids, :cloud_file_ids, :include_quoted_text, :include_original_attachments, :tweet_type, :twitter_handle_id, :inline_attachment_ids, :msg_type].freeze
