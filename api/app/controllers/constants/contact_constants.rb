module ContactConstants
  ...
  DEFAULT_FIELD_VALIDATIONS = {
    ...
    tag_names:  { data_type: { rules: Array, allow_unset: true, allow_nil: false }, array: { data_type: { rules: String }, length: { maximum: ApiConstants::TAG_MAX_LENGTH_STRING, message: :too_long } }, string_rejection: { excluded_chars: [','], allow_nil: true } },
