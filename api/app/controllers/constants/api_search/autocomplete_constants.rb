module ApiSearch::AutocompleteConstants
  ...
  AUTOCOMPLETE_PERMITTED_PARAMS = %i[name term query all context search_key q v only limit max_matches per_page page include].freeze
  AGENT_AUTOCOMPLETE_INCLUDE_PARAMS = %w[roles].freeze
