module GroupConstants
  ...
  FIELDS = %w(name description escalate_to unassigned_for auto_ticket_assign agent_ids).freeze | ARRAY_FIELDS.map { |x| Hash[x, [nil]] }
  ...
  FIELDS_TO_BE_STRIPPED = %w(name).freeze
