module ApiIntegrations
  module CtiConstants
    SCREEN_POP_FIELDS = %w(requester_id requester_phone requester_unique_external_id requester_email responder_id responder_phone responder_unique_external_id responder_email call_reference_id ticket_id new_ticket call_url).freeze
