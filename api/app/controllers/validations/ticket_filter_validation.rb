class TicketFilterValidation < FilterValidation
  ...
  validates :company_id, :requester_id, custom_numericality: { only_integer: true, greater_than: 0, allow_unset: true, ignore_string: :allow_string_param, greater_than: 0 }
