class TicketFilterValidation < ApiValidation
  ...
  validates :filter, included: { in: TicketConstants::TICKET_FILTER }, allow_nil: true
  validates :created_since, :updated_since, date_time: { allow_nil: true }
  validates :order_by, included: { in: TicketConstants::TICKET_ORDER_BY }, allow_nil: true
  validates :order_type, included: { in: TicketConstants::TICKET_ORDER_TYPE }, allow_nil: true
