class ContactValidation < ApiValidation
  ...
  validates :custom_fields, data_type: { rules: Hash, allow_nil: true }, custom_field: { custom_fields: {
  ...
  private
    ...
    def validate_avatar
      ...
      unless  avatar.original_filename.ends_with('.png') || avatar.original_filename.ends_with('.jpg') || avatar.original_filename.ends_with('.jpeg')
