module ApiDiscussions
  class ForumValidation < ApiValidation
    ...
    validates :company_ids, data_type: { rules: Array, allow_unset: true }, array: { custom_numericality: { only_integer: true, greater_than: 0, allow_nil: true, custom_message: :invalid_integer } }, if: :company_ids_allowed?
