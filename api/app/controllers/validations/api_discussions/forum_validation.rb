module ApiDiscussions
  class ForumValidation < ApiValidation
    ...
    validates :forum_visibility, inclusion: { in: DiscussionConstants::FORUM_VISIBILITY_KEYS_BY_TOKEN }
    validates :forum_type, inclusion: { in: DiscussionConstants::FORUM_TYPE_KEYS_BY_TOKEN }
