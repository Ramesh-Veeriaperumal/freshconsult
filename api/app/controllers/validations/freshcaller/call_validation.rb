class Freshcaller::CallValidation < ApiValidation
  attr_accessor :fc_call_id, :recording_status, :call_status, :call_created_at, :customer_number, :agent_number,
                :customer_location, :duration, :agent_email, :ticket_id, :note
  ...
  validates :ticket_id, data_type: { rules: String }
