module ApiConstants
 ...
 # ControllerConstants
    ...
    CREATE_POST_FIELDS = {:all => [:body_html, :answer, :topic_id], :view_admin => [:created_at, :updated_at, :email, :user_id]}
  ...
  # ErrorConstants
    API_ERROR_CODES = {
        ...
        :invalid_value => ["can't be blank", "is not included in the list"],
