...
class SidekiqConfigUsEast
  ...
  def self.get_pool(node)
    ...
    plan_change              = ["plan_change","pod_route_update","modify_ticket_status","plan_change_workerv2","activation_worker"]
    contact_import           = ["contact_import","company_import","data_export","broadcast_note","link_tickets","reset_associations","modify_ticket_status"]
    riak_s3_ticket           = ["update_sentiment","update_notes_sentiment"]
    riak_s3_note             = ["notify_broadcast_message"]
    ...
    archive                  = ['archive_account_tickets', 'archive_ticket', 'manual_publish', 'delayed_central_publish', 'es_v2_queue', 'central_realtime', 'archive_ticket_central_publish']
    external                 = ['external']
  ...
  "plan_change_workerv2", "activation_worker", "contact_import", "company_import",
  "update_sentiment",
  ...
  'marketplace_app_billing', 'privilege_modification', 'search_analytics_article_reindex', 'touchstone_account_update', 'central_publish_resync', 'create_and_link_omni_account', 'sync_omni_agents', 'retry_observer', 'freddy_consumed_session_queue', 'archive_ticket_central_publish'
]
    ...
    _REPORTS_POOL             = [[reports_one,2],[reports_two,2],[reset,1]]
...
class SidekiqConfigStandard
  ...
  def self.get_pool(node)
    ...
    cron_jobs                = ['cron_contacts_sync', 'cron_google_contacts_sync', 'cron_resque_watcher_check_load', 'cron_scheduler_sla', 'cron_scheduler_sla_reminder', 'cron_scheduler_supervisor', 'cron_forum_moderation_create_tables', 'cron_forum_moderation_drop_tables', 'cron_facebook_dm', 'cron_spam_digest_mailer', 'cron_twitter_custom_stream', 'cron_populate_spam_watcher_limits', 'cron_billing_info_update', 'cron_requeue_central_publish', 'cron_rollback_trail_subscriptions_data', 'cron_sidekiq_dead_set_mailer', 'cron_redis_maintenance', 'cron_ebay_daily_api_report_intimate', 'cron_reports_build_no_activity', 'cron_scheduled_task', 'cron_sitemap_generate', 'cron_traffic_switch_fetch_accounts', 'cron_long_running_queries_check', 'cron_gnip_stream_maintenance', 'cron_gnip_stream_replay', 'cron_social_create_dynamodb_tables', 'cron_social_delete_dynamodb_tables', 'cron_sqs_monitor', 'cron_account_spam_cleanup', 'cron_attachment_user_draft_cleanup', 'cron_delayedjobs_watcher', 'cron_failed_helpkit_feeds', 'cron_log_cloud_elements_sync', 'cron_meta_data_check', 'cron_enable_omniroute_for_new_accounts', 'cron_archive_automation', 'cron_suspended_accounts']
...
all_sidekiq_jobs =  cron_jobs + [
      ...
      "api_webhook_rule", "plan_change", "pod_route_update", "plan_change_workerv2", "activation_worker",
      "contact_import", "company_import",
      ...
      "product_feedback","block_account","signup_restricted_domain_validation","send_activation_reminder_mail",
      ...
      "archive_account_tickets_channel_queue", "archive_tickets_channel_queue", "ticket_properties_suggester", "update_agents_roles", "custom_translations_update_survey_status", 'kbase_article_versions_worker', 'kbase_article_versions_migration_worker', 'kbservice_clear_cache_worker',
