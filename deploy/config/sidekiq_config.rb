...
class SidekiqConfigUsEast
  ...
  'marketplace_app_billing', 'privilege_modification', 'search_analytics_article_reindex', 'touchstone_account_update', 'central_publish_resync', 'create_and_link_omni_account', 'sync_omni_agents', 'retry_observer', 'freddy_consumed_session_queue'
]
