class AddOmniChannelPlans2019 < ActiveRecord::Migration
  def up
    SubscriptionPlan.create(name: "Garden Omni Jan 19", amount: 45.0, renewal_period: 1,
    ...
    SubscriptionPlan.create(name: "Estate Omni Jan 19", amount: 85.0, renewal_period: 1,
