  ...
  def self.up
    execute <<-SQL
      INSERT INTO features 
        ...
        on subscriptions.subscription_plan_id = subscription_plans.id and subscriptions.amount > 0 
        where subscription_plans.name in ('Premium','Garden','Garden Classic','Estate','Estate Classic')
    SQL
  end
