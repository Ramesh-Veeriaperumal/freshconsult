  ...
  private
        ...
        Sharding.run_on_shard(s_n) do
          ...
          ActiveRecord::Base.connection.execute(
            "CREATE TABLE `survey_result_data` (
              ...
              `cf_int01` int(20) DEFAULT NULL,
              `cf_int02` int(20) DEFAULT NULL,
              `cf_int03` int(20) DEFAULT NULL,
              `cf_int04` int(20) DEFAULT NULL,
              `cf_int05` int(20) DEFAULT NULL,
              `cf_int06` int(20) DEFAULT NULL,
              `cf_int07` int(20) DEFAULT NULL,
              `cf_int08` int(20) DEFAULT NULL,
              `cf_int09` int(20) DEFAULT NULL,
              `cf_int10` int(20) DEFAULT NULL,
              `cf_int11` int(20) DEFAULT NULL,
              `cf_int12` int(20) DEFAULT NULL,
              `cf_int13` int(20) DEFAULT NULL,
              `cf_int14` int(20) DEFAULT NULL,
              `cf_int15` int(20) DEFAULT NULL,
              `cf_int16` int(20) DEFAULT NULL,
              `cf_int17` int(20) DEFAULT NULL,
              `cf_int18` int(20) DEFAULT NULL,
              `cf_int19` int(20) DEFAULT NULL,
              `cf_int20` int(20) DEFAULT NULL,
              `cf_int21` int(20) DEFAULT NULL,
              ...
              `cf_boolean11` tinyint(1) DEFAULT NULL,
              `cf_boolean12` tinyint(1) DEFAULT NULL,
              `cf_boolean13` tinyint(1) DEFAULT NULL,
              `cf_boolean14` tinyint(1) DEFAULT NULL,
              `cf_boolean15` tinyint(1) DEFAULT NULL,
              `cf_boolean16` tinyint(1) DEFAULT NULL,
              `cf_boolean17` tinyint(1) DEFAULT NULL,
              `cf_boolean18` tinyint(1) DEFAULT NULL,
              `cf_boolean19` tinyint(1) DEFAULT NULL,
              `cf_boolean20` tinyint(1) DEFAULT NULL,
    ...
    def add_columns_to_surveys
      Lhm.change_table :surveys, :atomic_switch => true do |m|
        ...
        m.add_column :can_comment, "tinyint(1) DEFAULT 0"
