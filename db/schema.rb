...
ActiveRecord::Schema.define(:version => 20141111083529) do
  ...
  add_index "contact_fields", ["account_id", "deleted"], :name => "index_contact_fields_on_account_id_and_deleted"
  add_index "contact_fields", ["account_id", "name"], :name => "index_contact_fields_on_account_id_and_name"

  create_table "contact_flexifields", :force => true do |t|
    t.integer  "account_id",        :limit => 8
    ...
    t.integer  "ff_decimal01"
    t.integer  "ff_decimal02"
    t.integer  "ff_decimal03"
    t.integer  "ff_decimal04"
    t.integer  "ff_decimal05"
    t.integer  "ff_decimal06"
    t.integer  "ff_decimal07"
    t.integer  "ff_decimal08"
    t.integer  "ff_decimal09"
    t.integer  "ff_decimal10"
  ...
  add_index "contact_flexifields", ["account_id", "flexifield_def_id"], :name => "index_contact_flexifields_on_account_id_and_flexifield_def_id"
  add_index "contact_flexifields", ["account_id", "int_uc01"], :name => "index_contact_flexifields_on_account_id_and_int_uc01"
  add_index "contact_flexifields", ["account_id", "int_uc02"], :name => "index_contact_flexifields_on_account_id_and_int_uc02"
  add_index "contact_flexifields", ["account_id", "long_uc01"], :name => "index_contact_flexifields_on_account_id_and_long_uc01"
  add_index "contact_flexifields", ["account_id", "long_uc02"], :name => "index_contact_flexifields_on_account_id_and_long_uc02"
  add_index "contact_flexifields", ["account_id", "user_id"], :name => "index_contact_flexifields_on_account_id_and_user_id", :unique => true
