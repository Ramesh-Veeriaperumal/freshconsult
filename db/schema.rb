...
ActiveRecord::Schema.define(:version => 20130614064141) do
  ...
  create_table "lhma_2013_06_17_14_32_31_552_sla_details", :force => true do |t|
    t.string   "name"
  ...
  add_index "lhma_2013_06_17_14_32_31_552_sla_details", ["account_id", "sla_policy_id"], :name => "index_account_id_and_sla_policy_id_on_sla_details"

  create_table "lhma_2013_06_17_14_46_32_392_users", :id => false, :force => true do |t|
    t.integer  "id",                  :limit => 8,                    :null => false
  ...
  add_index "lhma_2013_06_17_14_46_32_392_users", ["account_id", "email"], :name => "index_users_on_account_id_and_email", :unique => true
  add_index "lhma_2013_06_17_14_46_32_392_users", ["account_id", "external_id"], :name => "index_users_on_account_id_and_external_id", :unique => true, :length => {"external_id"=>"20", "account_id"=>nil}
  add_index "lhma_2013_06_17_14_46_32_392_users", ["account_id", "import_id"], :name => "index_users_on_account_id_and_import_id", :unique => true
  add_index "lhma_2013_06_17_14_46_32_392_users", ["id"], :name => "users_id"
  add_index "lhma_2013_06_17_14_46_32_392_users", ["perishable_token", "account_id"], :name => "index_users_on_perishable_token_and_account_id"
  add_index "lhma_2013_06_17_14_46_32_392_users", ["persistence_token", "account_id"], :name => "index_users_on_persistence_token_and_account_id"
  add_index "lhma_2013_06_17_14_46_32_392_users", ["single_access_token", "account_id"], :name => "index_users_on_account_id_and_single_access_token", :unique => true

  create_table "lhma_2013_06_17_14_54_32_940_es_enabled_accounts", :force => true do |t|
    t.integer  "account_id", :limit => 8
    t.string   "index_name"
    t.boolean  "imported",                :default => true
    t.datetime "created_at"
  ...
  add_index "lhma_2013_06_17_14_54_32_940_es_enabled_accounts", ["account_id"], :name => "index_es_enabled_accounts_on_account_id"

  create_table "lhma_2013_06_17_14_54_35_475_es_enabled_accounts", :force => true do |t|
    t.integer  "account_id", :limit => 8
    t.boolean  "imported",                :default => true
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "lhma_2013_06_17_14_54_35_475_es_enabled_accounts", ["account_id"], :name => "index_es_enabled_accounts_on_account_id"

  create_table "lhma_2013_06_24_17_53_05_667_business_calendars", :force => true do |t|
    t.integer  "account_id",         :limit => 8
    t.text     "business_time_data"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "lhma_2013_06_24_17_53_05_667_business_calendars", ["account_id"], :name => "index_business_calendars_on_account_id"

  create_table "lhma_2013_06_24_17_55_24_586_groups", :force => true do |t|
    t.string   "name"
    t.text     "description"
    t.integer  "account_id",         :limit => 8
    t.boolean  "email_on_assign"
  ...
  add_index "lhma_2013_06_24_17_55_24_586_groups", ["account_id", "name"], :name => "index_groups_on_account_id", :unique => true

  create_table "lhma_2013_07_01_18_42_31_934_accounts", :force => true do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "full_domain"
  ...
  add_index "lhma_2013_07_01_18_42_31_934_accounts", ["full_domain"], :name => "index_accounts_on_full_domain", :unique => true
  add_index "lhma_2013_07_01_18_42_31_934_accounts", ["helpdesk_url"], :name => "index_accounts_on_helpdesk_url"
  add_index "lhma_2013_07_01_18_42_31_934_accounts", ["time_zone"], :name => "index_accounts_on_time_zone"
