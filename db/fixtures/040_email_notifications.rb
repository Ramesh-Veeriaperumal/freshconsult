...
EmailNotification.seed_many(:account_id, :notification_type, [
  {
    ...
    :agent_template => 'Hi {{agent.name}},<br /><br />Your {{helpdesk_name}} account has been created.<br /><br />Click the url below to activate your account!<br /><br />{{activation_url}}<br /><br />If the above URL does not work try copying and pasting it into your browser. If you continue to have problems, please feel free to contact us.<br /><br />Regards,<br />{{helpdesk_name}}',
  ...
  { 
    ...
    :agent_template => 'Hi,<br /><br />A new ticket has been created. <br />You may view and respond to the ticket here {{ticket.url}}<br /><br />Regards,<br />{{helpdesk_name}}',
...
{{helpdesk_name}} Support Team</p>',
  ...
  { :notification_type => EmailNotification::TICKET_REOPENED, 
      ...
      :agent_template => 'Hi {{ticket.agent.name}},<br /><br />Ticket "#{{ticket.id}} - {{ticket.subject}}" has been reopened, please visit {{ticket.url}} to view the ticket.<br /><br />Ticket comment<br />{{comment.body}}',
