...
def self.plan_list(all_addons, estate_addons, garden_addons, blossom_addons, estate_17_addons, garden_17_addons, blossom_17_addons, sprout_17_addons, estate_19_addons, forest_19_addons, estate_20_addons, forest_20_addons)
  [
    ...
    { name: 'Sprout Jan 17', amount: 0, free_agents: 50_000, day_pass_amount: 0.00,
...
def self.plan_price
  {
    ...
    forest_jan_17: {
      ...
      'BRL' => 270.0,
      :FREDDY => {
        SELF_SERVICE: { EUR: 500.0, INR: 36_000.0, USD: 500.0, ZAR: 7500.0, GBP: 375.0, AUD: 725.0, BRL: 2600.0 },
        ULTIMATE: { EUR: 75.0, INR: 5400.0, USD: 75.0, ZAR: 1100.0, GBP: 55.0, AUD: 110.0, BRL: 390.0 },
        ADDITIONAL_PACKS: { EUR: 100.0, INR: 7200.0, USD: 100.0, ZAR: 1500.0, GBP: 75.0, AUD: 145.0, BRL: 520.0 },
        ULTIMATE_SESSION: { EUR: 500.0, INR: 36_000.0, USD: 500.0, ZAR: 7500.0, GBP: 375.0, AUD: 725.0, BRL: 2600.0 }
      }
    },
    sprout_jan_19: {
      'EUR' => 0.0,
...
unless Account.current
  ...
  auditlogui_unlimitedmultiproduct = Subscription::Addon.seed(:name) do |a|
    a.name = 'Audit Log UI And Multi Product Migration'
    a.amount = 0
    a.renewal_period = 1
    a.addon_type = addon_types[:for_account]
  end

  native_whatsapp = Subscription::Addon.seed(:name) do |a|
    a.name = 'Native Whatsapp'
    a.amount = 49.0
    a.renewal_period = 1
    a.addon_type = addon_types[:for_account]
  end
  ...
  estate_addons  = [custom_mailbox, whitelisted_ips, call_center_advanced, skill_based_round_robin, field_service_management, freddy_self_service, freddy_session_packs, native_whatsapp]
  garden_addons  = all_addons + [shared_ownership_toggle, field_service_management, freddy_self_service, freddy_session_packs, native_whatsapp] - [multiple_business_hours, custom_domain, custom_slas, custom_surveys, ticket_templates, sandbox]
  ...
  garden_17_addons  = all_addons + [shared_ownership_toggle, field_service_management, freddy_self_service, freddy_session_packs, native_whatsapp] - [custom_domain, custom_surveys, ticket_templates, sandbox]
  ...
  estate_19_addons = estate_17_addons + [fluffy_forest, fluffy_higher_plan1, fluffy_higher_plan2, fluffy_higher_plan3, fluffy_higher_plan4]
  forest_19_addons = [fluffy_higher_plan1, fluffy_higher_plan2, fluffy_higher_plan3, fluffy_higher_plan4, field_service_management, freddy_ultimate, freddy_self_service, freddy_session_packs, native_whatsapp]

  estate_20_addons = estate_19_addons + [auditlogui_unlimitedmultiproduct]
  forest_20_addons = forest_19_addons

  SubscriptionPlan.seed_many(:name, plan_list(all_addons, estate_addons, garden_addons, blossom_addons, estate_17_addons, garden_17_addons, blossom_17_addons, sprout_17_addons, estate_19_addons, forest_19_addons, estate_20_addons, forest_20_addons))
