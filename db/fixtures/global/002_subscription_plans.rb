def self.plan_list(sprout_addons, estate_addons, garden_addons, blossom_addons)
	[
    { :name => 'Sprout', :amount => 15, :free_agents => 3, :day_pass_amount => 1.00, 
    	:addons => sprout_addons, :price => plan_price[:sprout] },
...
unless Account.current
	...
	all_addons = [ agent_collision, custom_ssl, custom_roles, gamification, layout_customization, 
									...
									ticket_templates, round_robin_load_balancing, link_tickets_toggle, 
									parent_child_tickets_toggle ]

	estate_addons = [custom_mailbox, whitelisted_ips, shared_ownership_toggle]
	...
	sprout_addons = all_addons - [ link_tickets_toggle,  parent_child_tickets_toggle ]
  SubscriptionPlan.seed_many(:name, plan_list(sprout_addons, estate_addons, garden_addons, blossom_addons))
