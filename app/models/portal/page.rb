class Portal::Page < ActiveRecord::Base
	...
	PAGE_TYPES = [
		...
		[:forgot_password,    	4,  "support/registrations/forgot_password.portal", "new_password_reset_path"],
		[:profile_edit,       	5,  "support/profiles/edit.portal", "edit_profile_path"],
		[:search,    		  	    6,  "support/search/index", "support_solutions_path"],

		# Solution pages
		[:solution_home,      	7,   "support/solutions/index.portal", "support_solutions_path"],
		[:article_list,       	8,   "support/solutions/folders/show.portal", "support_solutions_folder_path", "portal_folders"],
		[:article_view,       	9,   "support/solutions/articles/show.portal", "support_solutions_article_path", "solution_articles"],

		# Discussion or Forum pages
		[:discussions_home,   	10,  "support/discussions/index.portal", "support_discussions_path"],
		[:topic_list,         	11,  "support/discussions/forums/show.portal", "support_discussions_forum_path", "forum_categories"],
		[:topic_view,         	12,  "support/discussions/topics/show.portal", "support_discussions_topic_post_path", "portal_topics"],
		[:new_topic,          	13,  "support/discussions/topics/new.portal", "new_support_discussions_topic_path"],
		
		# Ticket pages
		[:submit_ticket,      	14,  "support/tickets/new.portal", "new_support_ticket_path"],
		[:ticket_list,        	15,  "support/tickets/index.portal", "support_tickets_path"],
		[:ticket_view,        	16,  "support/tickets/show.portal", "support_ticket_path", "tickets"]
	]
