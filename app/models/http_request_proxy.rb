    ...
    begin
      ...
      begin
        if (params[:auth_type] == 'OAuth1')
          ...
          options[:verify_blacklist] = true unless params[:skip_blacklist_verification]
        ...
        if (response_type.present? && response_type.include?('xml') && params['app_name'] != 'constantcontact')
