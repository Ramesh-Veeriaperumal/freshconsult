...
class User < ActiveRecord::Base
  ...
  attr_accessor :import, :highlight_name, :highlight_job_title, :created_from_email, :sbrr_fresh_user,
                ...
                :role_ids_changed, :detect_language, :tag_use_updated, :user_companies_updated  # (This role_ids_changed used to forcefully call user callbacks only when role_ids are there.
