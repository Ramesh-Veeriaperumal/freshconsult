class SubscriptionPlan < ActiveRecord::Base
  ...
  BILLING_CYCLE_DISCOUNT = {SUBSCRIPTION_PLANS[:premium] => {BILLING_CYCLE_KEYS_BY_TOKEN[:anually] => 0.85},
                            SUBSCRIPTION_PLANS[:pro] => {BILLING_CYCLE_KEYS_BY_TOKEN[:anually] => 0.85},
