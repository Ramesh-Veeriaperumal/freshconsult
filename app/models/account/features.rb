class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :freshid_org_v2, :hide_agent_login, :addon_based_billing, :kbase_mint,:text_custom_fields_in_etl, :webhook_blacklist_ip, :sandbox_single_branch
  ].freeze
  ...
  BITMAP_FEATURES = [
    ...
    :auto_article_order, :detect_thank_you_note
