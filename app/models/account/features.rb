class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :feedback_widget_captcha, :gamification_perf, :force_index_tickets, :es_v2_splqueries
  ].freeze
  ...
  BITMAP_FEATURES = [
    ...
    :basic_settings_feature, :gamification_perf, :skip_portal_cname_chk, :stop_contacts_count_query, :force_index_tickets, :es_v2_splqueries
  ...
  LP_TO_BITMAP_MIGRATION_FEATURES = [
    ...
    :force_index_tickets, :es_v2_splqueries
  ].freeze
