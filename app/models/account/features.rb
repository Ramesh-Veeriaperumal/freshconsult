class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [:select_all, :round_robin_capping, :suggest_tickets,
                 ...
                 :encode_emoji, :dependent_field_validation, :post_central_publish,
                 ...
                 :description_by_request, :ticket_fields_central_publish, :skip_invoice_due_warning,  :facebook_page_scope_migration]
