class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :freshid_org_v2, :hide_agent_login, :security_new_settings,
    ...
    :launch_kbase_omni_bundle, :cron_api_trigger, :whatsapp_addon, :enhanced_freshcaller_search, :auto_recharge_eligible, :retry_ticket_supervisor_actions, :hide_first_response_due_setting, :prevent_cc_email_parallel_update, :omni_groups, :redaction_lp, :escalate_without_sla_management
  ...
  BITMAP_FEATURES = [
    ...
    :whatsapp_channel, :basic_settings_feature, :ticket_filter_increased_companies_limit, :secure_fields_toggle, :forums, :ticket_summary_feature, :link_tickets_toggle, :shared_ownership_toggle, :redaction
  ...
  def redaction_enabled?
    launched?(:redaction_lp) && has_feature?(:redaction)
  end
