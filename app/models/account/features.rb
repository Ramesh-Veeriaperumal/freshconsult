class Account < ActiveRecord::Base
  ...
  BITMAP_FEATURES = [:split_tickets, :add_watcher, :traffic_cop, :custom_ticket_views, :supervisor, :create_observer, :sla_management,
    ...
    :auto_refresh, :branding, :advanced_dkim, :basic_dkim, :shared_ownership_toggle, :unique_contact_identifier_toggle, :unique_contact_identifier, :ticket_activity_export].concat(ADVANCED_FEATURES + ADVANCED_FEATURES_TOGGLE)
