class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :onboarding_inlinemanual, :skip_portal_cname_chk, :ticket_source_revamp,
    ...
    :dashboard_java_fql_performance_fix, :emberize_business_hours, :trigger_domain_mapping_deletion, :chargebee_omni_upgrade, :ticket_observer_race_condition_fix, :csp_reports
  ].freeze
