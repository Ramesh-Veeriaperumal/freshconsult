class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :force_index_tickets, :es_v2_splqueries, :launch_kbase_omni_bundle
  ].freeze
  ...
  BITMAP_FEATURES = [
    ...
    :allow_wildcard_ticket_create, :supervisor_contact_field, :whatsapp_channel,
    :basic_settings_feature, :skip_portal_cname_chk, :stop_contacts_count_query, :force_index_tickets, :es_v2_splqueries, :disable_emails
