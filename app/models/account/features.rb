class Account < ActiveRecord::Base
  ...
  BITMAP_FEATURES = [
    ...
    :whatsapp_channel, :basic_settings_feature, :ticket_filter_increased_companies_limit, :secure_fields_toggle, :forums, :ticket_summary_feature, :link_tickets_toggle
