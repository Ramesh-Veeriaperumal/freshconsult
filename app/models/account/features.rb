class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :mailbox_forward_setup, :remove_image_attachment_meta_data, :automated_private_notes_notification,
    ...
    :omni_plans_migration_banner, :parse_replied_email, :wf_comma_filter_fix, :composed_email_check, :omni_channel_dashboard, :csat_for_social_surveymonkey, :fresh_parent, :trim_special_characters
  ].freeze
  ...
  BITMAP_FEATURES = [
    ...
    :custom_objects, :quality_management_system, :kb_allow_base64_images
