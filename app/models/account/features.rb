class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :observer_race_condition_fix, :contact_graphical_avatar, :omni_bundle_2020, :article_versioning_redis_lock, :hypertrail_activities, :freshid_sso_sync, :fw_sso_admin_security, :cre_account, :cdn_attachments, :handle_custom_fields_conflicts
  ].freeze
  ...
  BITMAP_FEATURES = [
    ...
    :twitter_field_automation, :robo_assist, :triage, :advanced_article_toolbar_options, :advanced_freshcaller
