class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :sane_restricted_helpdesk, :hiding_confidential_logs, :fb_ad_post_stream_publish, :ticket_list_performance, :sla_policy_revamp, :help_widget_log, :freshdesk_freshsales_bundle
  ].freeze
