class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :prevent_lang_detect_for_spam, :jira_onpremise_reporter, :sidekiq_logs_to_central, :portal_central_publish, :global_navbar, :advanced_automations, :encode_emoji_in_solutions,
