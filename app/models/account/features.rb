class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :archive_on_missing_associations, :mailbox_ms365_oauth, :pre_compute_ticket_central_payload, :security_revamp, :skip_ticket_threading
  ].freeze
  ...
  BITMAP_FEATURES = [
    ...
    :fetch_ticket_from_ref_first, :skip_ticket_threading
