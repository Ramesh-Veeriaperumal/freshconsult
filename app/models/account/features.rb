class Account < ActiveRecord::Base
  ...
  LP_FEATURES = [
    ...
    :launch_kbase_omni_bundle, :cron_api_trigger, :whatsapp_addon, :enhanced_freshcaller_search
  ...
  BITMAP_FEATURES = [
    ...
    :supervisor_contact_field, :whatsapp_channel, :sidekiq_logs_to_central, :basic_settings_feature, :ticket_filter_increased_companies_limit,
