class Account < ActiveRecord::Base
  ...
  has_many :ticket_bodies, :class_name => 'Helpdesk::TicketOldBody', :dependent => :delete_all
  has_many :notes, :class_name => 'Helpdesk::Note', :dependent => :delete_all
  has_many :note_bodies, :class_name => 'Helpdesk::NoteOldBody', :dependent => :delete_all
