class Account < ActiveRecord::Base
  ...
  delegate :supported_languages, :secret_keys, :max_template_limit, :max_skills_per_account, :feedback_widget_captcha_allowed?, :allow_iframe_embedding, :feedback_widget_attach_file?, :feedback_widget_attach_screenshot?, to: :account_additional_settings_from_cache
  ...
  has_many :full_time_support_agents, :through =>:users, :conditions => { :occasional => false,
                                                                  :agent_type => Agent::SUPPORT_AGENT_TYPE,
                                                                  :users=> { :deleted => false } }
  ...
  :rule_type => VAConfig::SUPERVISOR_RULE }, :order => 'active desc, position'
  ...
  has_many :write_access_agent_groups, class_name: 'AgentGroup', conditions: { write_access: true }
  ...
  has_many :associated_forums, class_name: 'Forum'
  ...
  has_many :picklist_values_only, class_name: 'Helpdesk::PicklistValue'
