class Account < ActiveRecord::Base
  ...
  LAUNCHPARTY_FEATURES = {
    ...
    bot_agent_response: false, fluffy: false, nested_field_revamp: true,
    ...
    attachment_redirect_expiry: false, independent_service_task: false,
    ...
    enhanced_freshcaller_search: false, threading_without_user_setting: false, hide_first_response_due_setting: false, omni_groups: false
  }.freeze
