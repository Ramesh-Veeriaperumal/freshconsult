class Account < ActiveRecord::Base
  ...
  RESERVED_DOMAINS = %W[
    blog help chat smtp mail www ftp imap pop faq docs doc team people india us
    upload download info lounge community forums ticket tickets tour about pricing
    logs projects itil marketing store channel reseller resellers online talk
    admin #{AppConfig['admin_subdomain']} girish shan vijay parsu kiran shihab
    productdemo resources static static0 static1 static2 static3 static4 static5
    static6 static7 static8 static9 static10 dev apps freshapps fone bugs in out
    elb elb1 elb2 elb3 elb4 elb5 elb6 elb7 elb8 elb9 elb10 agent-hermes contact
    attachment euattachment eucattachment ausattachment indattachment cobrowsing
  ] + FreshopsSubdomains + PartnerSubdomains

  PLANS_AND_FEATURES = {
    basic: {
      features: [:twitter, :custom_domain, :multiple_emails]
    },
    pro: {
      features: [
        :gamification, :scenario_automations, :customer_slas,
        :business_hours, :forums, :surveys, :scoreboard, :facebook, :timesheets,
    ...
    premium: {
      features: [
        :multi_product, :multi_timezone, :multi_language,
        :enterprise_reporting, :dynamic_content
      ],
      inherits: [:pro] # To make the hierarchy easier
    },
    sprout: {
      features: [
        :scenario_automations, :business_hours
      ]
    },
    blossom: {
      features: [
        :gamification, :auto_refresh, :twitter, :facebook, :forums,
        :surveys, :scoreboard, :timesheets, :custom_domain, :multiple_emails,
        :advanced_reporting, :default_survey, :sitemap, :requester_widget
      ],
      inherits: [:sprout]
    },
    garden: {
      features: [
        :multi_product, :customer_slas, :multi_timezone, :multi_language,
        :css_customization, :advanced_reporting, :multiple_business_hours,
        :dynamic_content, :ticket_templates, :custom_survey
      ],
      inherits: [:blossom]
    },
    estate: {
      features: [
        :collision, :layout_customization, :round_robin,
        :enterprise_reporting, :custom_ssl, :custom_roles, :multiple_business_hours,
        :facebook_page_tab, :dynamic_sections, :helpdesk_restriction_toggle,
        :round_robin_load_balancing, :multiple_user_companies, :multiple_companies_toggle,
        :round_robin_on_update, :multi_dynamic_sections
      ],
      inherits: [:garden]
    },
    forest: {
      features: [
        :mailbox, :whitelisted_ips, :skill_based_round_robin
      ],
      inherits: [:estate]
    },
    sprout_classic: {
      features: [
        :scenario_automations, :business_hours, :custom_domain, :multiple_emails
      ]
    },
    blossom_classic: {
      features: [
        :gamification, :auto_refresh, :twitter, :facebook, :forums,
        :surveys, :scoreboard, :timesheets, :advanced_reporting
      ],
    ...
    estate_classic: {
      features: [
        ...
        :dynamic_sections, :helpdesk_restriction_toggle, :round_robin_load_balancing,
        :multiple_user_companies, :multiple_companies_toggle, :round_robin_on_update,
    ...
    blossom_jan_17: {
      features: [
        :gamification, :auto_refresh, :twitter, :facebook, :surveys,
        :scoreboard, :timesheets, :custom_domain, :multiple_emails, :advanced_reporting,
        :default_survey, :sitemap, :requester_widget
      ],
      inherits: [:sprout_jan_17]
    },
    garden_jan_17: {
      features: [
        :forums, :multi_language, :css_customization, :advanced_reporting,
        :dynamic_content, :ticket_templates, :custom_survey
      ],
    ...
    estate_jan_17: {
      features: [
        :multi_product, :customer_slas, :multi_timezone, :multi_dynamic_sections,
        :collision, :layout_customization, :round_robin, :enterprise_reporting,
        :custom_ssl, :custom_roles, :multiple_business_hours, :facebook_page_tab,
        :dynamic_sections, :helpdesk_restriction_toggle, :round_robin_load_balancing,
        :multiple_user_companies, :multiple_companies_toggle, :round_robin_on_update,
    ...
    forest_jan_17: {
      features: [
        :mailbox, :whitelisted_ips
      ],
      inherits: [:estate_jan_17]
    }
  }.freeze

  ADVANCED_FEATURES = [:link_tickets, :parent_child_tickets, :shared_ownership, :field_service_management].freeze
  ADVANCED_FEATURES_TOGGLE = ADVANCED_FEATURES.map { |f| "#{f}_toggle".to_sym }.freeze
  ...
  TEMPORARY_FEATURES = {
    bi_reports: false, contact_merge_ui: false, social_revamp: true, sandbox_account: false,
    multiple_user_emails: false, round_robin_revamp: false, facebook_realtime: false,
    autorefresh_node: false, tokenize_emoji: false, custom_dashboard: false,
    updated_twilio_client: false, report_field_regenerate: false, reports_regenerate_data: false,
    chat_enable: false, saml_old_issuer: false, spam_dynamo: true, redis_display_id: true,
    es_multilang_solutions: false, sort_by_customer_response: false, survey_links: true,
    tags_filter_reporting: false, saml_unspecified_nameid: false, euc_hide_agent_metrics: false,
    single_session_per_user: false, marketplace_app: false, collaboration: false
  }.freeze

  # to be removed in DB to bitmap phase 3 changes.
  # NOTE ::: Before adding any new features, please have a look at the TEMPORARY_FEATURES
  SELECTABLE_FEATURES = {
    gamification_enable: false, portal_cc: false, salesforce_v2: false,
    personalized_email_replies: false, agent_collision: false, freshfone: false,
    cascade_dispatchr: false, id_less_tickets: false, advanced_search: false,
    reply_to_based_tickets: true, no_list_view_count_query: false, countv2_reads: false,
    collision_socket: false, resource_rate_limit: false, cti: false, chat: false,
    disable_agent_forward: false, call_quality_metrics: false, chat_routing: false,
    disable_rr_toggle: false, domain_restricted_access: false, fa_developer: true,
    freshfone_conference: false, marketplace: true, skill_based_round_robin: false,
    archive_tickets: false, compose_email: false, freshfone_onboarding: false,
    limit_mobihelp_results: false, ecommerce: false, dynamics_v2: false,
    es_v2_writes: true, shared_ownership: false, salesforce_sync: false,
    freshfone_call_metrics: false, advanced_search_bulk_actions: false,
    threading_without_user_check: false, freshfone_call_monitoring: false,
    freshfone_caller_id_masking: false, agent_conference: false, cobrowsing: false,
    freshfone_warm_transfer: false, restricted_helpdesk: false, count_es_reads: false,
    enable_multilingual: false, count_es_writes: false, freshfone_gv_forward: false,
    activity_revamp: true, countv2_writes: false, helpdesk_restriction_toggle: false,
    freshfone_acw: false, ticket_templates: false, client_debugging: false,
    all_notify_by_custom_server: false, freshfone_custom_forwarding: false
  }.freeze
  ...
  ADMIN_CUSTOMER_PORTAL_FEATURES = {
    anonymous_tickets: true, open_solutions: true, auto_suggest_solutions: true,
    open_forums: false, signup_link: true, captcha: false, moderate_all_posts: false,
    google_signin: true, moderate_posts_with_links: true, hide_portal_forums: false,
    twitter_signin: true, forum_captcha_disable: false, public_ticket_url: false,
    facebook_signin: true
  }.freeze

  MAIL_PROVIDER = { sendgrid: 1, mailgun: 2 }.freeze

  # Features that need to connect to the FDnode server
  FD_NODE_FEATURES = ['cti'].freeze
  ...
  LAUNCHPARTY_FEATURES = [TEMPORARY_AND_SELECTABLE_FEATURES_TO_LP].reduce(
    {
      ...
      product_central_publish: false, field_service_management_lp: false, help_widget: false,
