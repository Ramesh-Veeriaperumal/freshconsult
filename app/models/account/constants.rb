class Account < ActiveRecord::Base
  ...
  RESERVED_DOMAINS = %W(  blog help chat smtp mail www ftp imap pop faq docs doc team people india us talk
                          ...
                          attachment euattachment eucattachment ausattachment indattachment cobrowsing migrations migrations-eu migrations-au migrations-ind) + FreshopsSubdomains + PartnerSubdomains
  ...
  LAUNCHPARTY_FEATURES = [TEMPORARY_AND_SELECTABLE_FEATURES_TO_LP].reduce(
    {
      ...
      fsm_for_garden_plan: false, requester_widget_timeline: false, enable_secure_login_check: false, contact_form_enhancement: false, enable_twitter_requester_fields: true
    }, :merge
  )
