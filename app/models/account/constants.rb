  ...
  LAUNCHPARTY_FEATURES = [TEMPORARY_AND_SELECTABLE_FEATURES_TO_LP].reduce(
    {
      ...
      product_central_publish: false, help_widget: false, field_tech_role: false,
      ...
      facebook_post_outgoing_attachment: false, outgoing_tweets_to_tms: false, incoming_mentions_in_tms: false, prevent_lang_detect_for_spam: false, 
    }, :merge
  )
