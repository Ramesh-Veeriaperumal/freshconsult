class Account < ActiveRecord::Base
  ...
  SELECTABLE_FEATURES = {
    ...
    :agent_conference => false, :restricted_helpdesk => false, :enable_multilingual => false, :count_es_writes => false, :count_es_reads => false,
    :salesforce_crm_sync => false, :dynamics_crm_sync => false }
