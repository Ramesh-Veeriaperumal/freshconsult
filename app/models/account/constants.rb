class Account < ActiveRecord::Base
  ...
  LAUNCHPARTY_FEATURES = {
    ...
    :whitelist_sso_login => false, :apigee => false, :contact_delete_forever => false, :imap_error_status_check => false, :va_any_field_without_none => false, :auto_complete_off => false, :freshworks_omnibar => false
  }
