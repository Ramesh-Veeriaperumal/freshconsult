class Account < ActiveRecord::Base
  ...
  LAUNCHPARTY_FEATURES = {
    ...
    mailbox_ms365_oauth: true, pre_compute_ticket_central_payload: false, channel_command_reply_to_sidekiq: false, cron_api_trigger: false, portal_new_settings: false, whatsapp_addon: false,
