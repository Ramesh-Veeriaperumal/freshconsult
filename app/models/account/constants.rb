class Account < ActiveRecord::Base
  ...
  LAUNCHPARTY_FEATURES = {
    ...
    :es_msearch => true, :canned_forms => false, :attachment_virus_detection => false, sso_login_expiry_limitation: false,
    ...
    :description_by_request => true, :ticket_fields_central_publish => false, :skip_invoice_due_warning => false
  }
