class Account < ActiveRecord::Base
  ...
  LAUNCHPARTY_FEATURES = {
    ...
    :va_any_field_without_none => false, :audit_logs_central_publish => false, :auto_complete_off => false, :freshworks_omnibar => false, :dependent_field_validation => false, :post_central_publish => false
  }
