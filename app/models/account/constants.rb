  ...
  LAUNCHPARTY_FEATURES = [TEMPORARY_AND_SELECTABLE_FEATURES_TO_LP].reduce(
    {
      ...
      fsm_scheduler_month_view: false, solutions_dashboard: false, facebook_post_outgoing_attachment: true, article_versioning_redis_lock: false, show_ssl_config: false
    }, :merge
  )
