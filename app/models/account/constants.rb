  ...
  LAUNCHPARTY_FEATURES = [TEMPORARY_AND_SELECTABLE_FEATURES_TO_LP].reduce(
    {
      ...
      fsm_for_garden_plan: false, fsm_for_blossom_plan: false, requester_widget_timeline: false, enable_secure_login_check: false, enable_twitter_requester_fields: true, marketplace_gallery: false,
      ...
      fsm_scheduler_month_view: false, facebook_post_outgoing_attachment: true, solutions_dashboard: false, freshid_sso_sync: false, fw_sso_admin_security: false, article_versioning_redis_lock: false, show_ssl_config: false, handle_custom_fields_conflicts: false
    }, :merge
  )
