class Account < ActiveRecord::Base
  ...
  SELECTABLE_FEATURES = {:open_forums => true, :open_solutions => true, :auto_suggest_solutions => true,
    ...
    :solutions_meta_read => false, :threading_without_user_check => false, :custom_dashboard => false, :freshfone_call_monitoring => false, :gamification_perf => false, :enable_multilingual => false }
