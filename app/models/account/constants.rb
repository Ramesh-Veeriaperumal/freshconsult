class Account < ActiveRecord::Base
  ...
  RESERVED_DOMAINS = %W(  blog help chat smtp mail www ftp imap pop faq docs doc team people india us talk
                          ...
                          attachment euattachment eucattachment ausattachment indattachment cobrowsing migrations migrations-eu migrations-au migrations-ind authz authz-euc authz-ind authz-au) + FreshopsSubdomains + PartnerSubdomains
  ...
  LAUNCHPARTY_FEATURES = [TEMPORARY_AND_SELECTABLE_FEATURES_TO_LP].reduce(
    {
      ...
      scheduling_fsm_dashboard: false, fb_ad_post_permission: false,
      ...
      fsm_for_garden_plan: false, requester_widget_timeline: false, enable_secure_login_check: false, contact_form_enhancement: false, enable_twitter_requester_fields: true, marketplace_gallery: false, fb_twitter_public_api: false
    }, :merge
  )
