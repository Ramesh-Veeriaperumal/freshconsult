class Account < ActiveRecord::Base
  ...
  LAUNCHPARTY_FEATURES = {
    ...
    activity_ui: false, customer_sentiment: false, countv2_template_write: false, logout_logs: false,
    ...
    skip_posting_to_fb: true, launch_fsm_geolocation: false, allow_update_agent: false,
    ...
    enable_secure_login_check: false, enable_twitter_requester_fields: true,
    ...
    ticket_filters_central_publish: false
  }.freeze
