  ...
  LAUNCHPARTY_FEATURES = [TEMPORARY_AND_SELECTABLE_FEATURES_TO_LP].reduce(
    {
      ...
      check_wc_fwd: false, attachment_redirect_expiry: false, solutions_agent_portal: false, solutions_agent_metrics: false, requester_privilege: false, allow_huge_ccs: false
    }, :merge
  )
