class Mobihelp::TicketInfo < ActiveRecord::Base
  ...
  APP_INFO_VARS = %w{app_name app_identifier app_version app_locale os os_version os_locale device_make device_model 
                      ...
                      storage_space_internal storage_space_sd}
