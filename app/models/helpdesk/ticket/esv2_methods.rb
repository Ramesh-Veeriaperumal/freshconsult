...
class Helpdesk::Ticket < ActiveRecord::Base
  ...
  def search_fields_updated?
    ...
    include_fields = es_flexifield_columns | Helpdesk::SchemaLessTicket::SCHEMA_LESS_SEARCH_FIELDS
  ...
  def to_indexed_json
    as_json({
            ...
            :tailored_json => true,
            :methods => [ :company_id, :es_from, :to_emails, :es_cc_emails, :es_fwd_emails] | Helpdesk::SchemaLessTicket::SCHEMA_LESS_SEARCH_FIELDS,
