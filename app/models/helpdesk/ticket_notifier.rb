...
class  Helpdesk::TicketNotifier < ActionMailer::Base
  ...
  def email_notification(params)
    ...
    headers       "Reply-to" => "#{ticket_based_friendly_email(params[:ticket])}", "Auto-Submitted" => "auto-generated", "X-Auto-Response-Suppress" => "DR, RN, OOF, AutoReply"
    sent_on       Time.now
  ...
  def reply(ticket, note , options={})
    ...
    headers       "Reply-to" => "#{modified_reply_email(note.from_email, ticket)}", "Auto-Submitted" => "auto-generated", "X-Auto-Response-Suppress" => "DR, RN, OOF, AutoReply"
    sent_on       Time.now
    content_type  "multipart/mixed"
  ...
  def forward(ticket, note, options={})
   ...
   def send_cc_email(ticket,options={})
    ...
    headers       "Reply-to" => "#{ticket_based_friendly_email(ticket)}", "Auto-Submitted" => "auto-generated", "X-Auto-Response-Suppress" => "DR, RN, OOF, AutoReply"
    sent_on       Time.now
    content_type  "multipart/mixed"
  ...
  def notify_comment(ticket, note , reply_email, options={})
    ...
    from          reply_email
    headers       "Reply-to" => "#{modified_reply_email(reply_email, ticket)}", "Auto-Submitted" => "auto-generated", "X-Auto-Response-Suppress" => "DR, RN, OOF, AutoReply"
    sent_on       Time.now
    content_type  "multipart/mixed"
  ...
  def email_to_requester(ticket, content, sub=nil)
    ...
    from          ticket.friendly_reply_email
    headers       "Reply-to" => "#{ticket_based_friendly_email(ticket)}", "Auto-Submitted" => "auto-replied", "X-Auto-Response-Suppress" => "DR, RN, OOF, AutoReply"
    sent_on       Time.now
    content_type  "multipart/mixed"
