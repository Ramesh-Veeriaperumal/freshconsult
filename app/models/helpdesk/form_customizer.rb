class Helpdesk::FormCustomizer < ActiveRecord::Base
   ...
   DEFAULT_FIELDS_JSON   = '[{"fieldType":"default", "type": "text",      "label": "Requester",   "description": "Enter requester name",      
                             ...
                             {"fieldType":"default", "type": "dropdown",  "label": "Source",      "description": "Source of the request",     
                                                                                                  "choices": [{"value": "Staff initiated", "tags": []}, {"value": "E-mail", "tags": []}], "setDefault": 0, 
                                                                                                  "agent": {"required": true}, 
                                                                                                  "customer": {"visible": true, "editable": false, "required": true}}, 
                             {"fieldType":"default", "type": "dropdown",  "label": "Status",      "description": "Status of the request",     
                                                                                                  "choices": [{"value": "Open", "tags": []}, {"value": "Closed", "tags": []}], "setDefault": 0, 
                                                                                                  "agent": {"required": true}, 
                                                                                                  "customer": {"visible": true, "editable": false, "required": true}}, 
                             {"fieldType":"default", "type": "dropdown",  "label": "Priority",    "description": "",                          
                                                                                                  "choices": [{"value": "Low", "tags": []}, {"value": "High", "tags": []}], "setDefault": 0, 
                                                                                                  "agent": {"required": true}, 
                                                                                                  "customer": {"visible": true, "editable": false, "required": true}}, 
                             {"fieldType":"default", "type": "dropdown",  "label": "Group", "description": "",                          
                                                                                                  "choices": [{"value": "Not Assigned", "tags": []}], "setDefault": 0, 
                                                                                                  "agent": {"required": true}, 
                                                                                                  "customer": {"visible": true, "editable": false, "required": true}}, 
                             {"fieldType":"default", "type": "dropdown",  "label": "Assigned to", "description": "",                          
                                                                                                  "choices": [{"value": "Not Assigned", "tags": []}], "setDefault": 0, 
                                                                                                  "agent": {"required": true}, 
                                                                                                  "customer": {"visible": true, "editable": false, "required": true}}, 
