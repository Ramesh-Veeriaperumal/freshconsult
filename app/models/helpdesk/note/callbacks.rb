  ...
  protected
    ...
    def send_notifications
      ...
      if user.customer?
        ...
        Helpdesk::TicketNotifier.send_later(:send_cc_email, notable , self, {}) if public_note?
      else    
        ...
        Helpdesk::TicketNotifier.send_later(:send_cc_email, notable , self, {:cc_emails => @prev_cc_email[:reply_cc]})
