class Helpdesk::PicklistValue < ActiveRecord::Base
  ...
  clear_memcache [ACCOUNT_SECTION_FIELD_PARENT_FIELD_MAPPING, ACCOUNT_SECTION_FIELDS_WITH_FIELD_VALUE_MAPPING, TICKET_FIELDS_FULL, ACCOUNT_CUSTOM_DROPDOWN_FIELDS]
