...
class BusinessCalendar < ActiveRecord::Base
  ...
  HOLIDAYS_SEED_DATA ='[["Jan 17", "Birthday of Martin Luther King Jr"], ["Feb 21", "Washington’s Birthday"], ["May 30", "Memorial Day"],
                        ["Jul 04", "Independence Day"],["Sep 05", "Labor Day"],["Oct 10", "Columbus Day"],["Nov 11", "Veterans Day"],
                        ["Nov 24", "Thanksgiving Day"],["Dec 26", "Christmas Day"],["Dec 31", "New Year’s Day"]]'
