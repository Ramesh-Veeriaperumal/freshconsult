module SubscriptionsHelper 
  ...
  PLANS_FEATURES = {
    ...
    "sprout jan 19" => [ "email_ticketing", "ticket_dispatch_automation" ,"knowledge_base",
      "basic_social", "freshchat", "freshcaller" ],
    "blossom jan 19" => [ "everything_in_sprout", "multiple_mailboxes", "app_gallery",
      "time_event_automation", "custom_domain", "satisfaction_survey", "ticket_templates",
      "helpdesk_report", "custom_ticket_fields_and_views", "agent_collision"],
    "garden jan 19" => [ "everything_in_blossom", "m_k_base", "dynamic_email_alert",
      "sla_reminders", "forums", "agent_performance_report", "scheduled_reports",
      "custom_surveys", "custom_apps", "timesheets"],
    "estate jan 19" => [ "everything_in_garden", "multiple_products", "multiple_sla",
      "portal_customization", "custom_roles", "auto_ticket_assignment",
      "enterprise_reports", "custom_dashboard"],
    "forest jan 19" => [ "everything_in_estate", "ip_whitelisting", "skill_based_assignment",
      "sandbox", "custom_data_center"]
  }
  ...
  PLANS_FEATURES_LOSS_2019 = {
    ...
    "estate jan 19" => ["multiple_products_desc", "multiple_sla_business_desc",
      "portal_customization_desc", "custom_ssl_desc", "auto_ticket_assignment_desc",
      "enterprise_reports_desc", "custom_dashboard_desc"],
    "forest jan 19" => ["multiple_products_desc", "skill_based_assignment_desc",
      "sandbox_desc", "custom_data_center_desc"]
  }
  ...
  EQUAL_PLAN_HASH = {
    ...
    "sprout jan 19" => {:type_flag => 0, :features => ["time_event_automation_desc",
      "sla_reminders" , "shared_ticket_views_desc", "custom_fields_desc",
      "custom_ticket_views_desc", "cname_dkim_desc", "multiple_mailbox_desc"]},
    "blossom jan 19" => {:type_flag => 0, :features => ["forums_desc"]},
    "garden jan 19" => {:type_flag => 0, :features => ["multiple_products_desc",
      "multiple_sla_business_desc"]},
