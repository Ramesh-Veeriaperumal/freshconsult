module Helpdesk::TicketsHelper
  ...
  def bind_last_conv (item, signature, forward = false)
    ...
    default_reply = "<span id='caret_pos_holder' style='display:none'>&nbsp;</span><br/><br/>"+signature #modified for the new redactor editor stylesheet
    if(!forward)
      ...
      if(!requester_template.nil?)
        ...
        default_reply ="<span id='caret_pos_holder' style='display:none'></span>"+reply_email_template+"<br/>"+signature #modified for the new redactor editor stylesheet
      end 
    end
