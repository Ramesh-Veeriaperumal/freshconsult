class Integrations::SalesforceController < ApplicationController
	...
	def fields_metadata
		begin
			...
			configs_hash['contact_fields'] = fetch_sf_contact_fields(configs_hash['oauth_token'], configs_hash['instance_url']) 
	    configs_hash['lead_fields'] = fetch_sf_lead_fields(configs_hash['oauth_token'], configs_hash['instance_url']) 
