class Admin::Ecommerce::EbayAccountsController < Admin::Ecommerce::AccountsController
  ...
  skip_filter :determine_pod, :select_shard, :set_current_account, :ensure_proper_sts_header, :ensure_proper_protocol,
              :check_session_timeout, only: [:authorize, :notify], if: :non_global_pods?
