class Helpdesk::CaFoldersController < ApplicationController
	...
	def show
    @ca_responses = fetch_from_es("Admin::CannedResponses::Response", {:load => Admin::CannedResponses::Response::INCLUDE_ASSOCIATIONS_BY_CLASS, :size => 300}, default_visiblity, "raw_title", params[:id])
