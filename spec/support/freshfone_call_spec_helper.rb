module FreshfoneCallSpecHelper
  ...
  def in_call_params
    { "AccountSid"=>"AC626dc6e5b03904e6270f353f4a2f068f", "CallStatus"=>"in-progress", "CalledVia"=>"+18433534240", 
      ...
      "ApiVersion"=>"2010-04-01", "FromCity"=>"BAKERSFIELD", "ForwardedFrom"=>"+18433534240", "Caller"=>"+16617480240", 
      "CallerState"=>"CA", "CallSid"=>"CSATH", "From"=>"+16617480240", "CallerZip"=>"93307", 
      "FromZip"=>"93307", "agent"=>"#{@agent.id}"}
  end

  def direct_dial_params
    { "AccountSid"=>"AC626dc6e5b03904e6270f353f4a2f068f", "CalledVia"=>"+18433534240", "FromState"=>"CA", "ToZip"=>"", 
      "Called"=>"+919994269753", "ParentCallSid"=>"CDIRECTPARENT", "FromCountry"=>"US", 
      "CallerCountry"=>"US", "CalledZip"=>"", "Direction"=>"outbound-dial", "FromCity"=>"BAKERSFIELD", "ForwardedFrom"=>"+18433534240", 
  ...
  def status_params
    { "AccountSid"=>"AC626dc6e5b03904e6270f353f4a2f068f", "ToZip"=>"79097", "FromState"=>"CA", "Called"=>"+18433534240", 
      ...
      "To"=>"+18433534240", "ToCountry"=>"US", "DialCallStatus"=>"completed", "RecordingDuration"=>"3", 
