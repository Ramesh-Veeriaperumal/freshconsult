module AutomationsHelper
  ...
  def create_scn_automation_rule (params={})
    va_rule=Factory.build(:scn_automation, :name=>"created by #{Faker::Name.name}", :description=>Faker::Lorem.sentence(2),
  ...
  def create_dispatchr_rule (params={})
    ...
    va_rule=Factory.build(:va_rule, :name=>"created by #{Faker::Name.name}", :description=>Faker::Lorem.sentence(2),
                          :action_data => [{:name=> "priority", :value=>"3"}],
