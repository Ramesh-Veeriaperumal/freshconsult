module SolutionsHelper
  ...
  def create_category(params = {})
    ...
    test_category.account_id = RSpec.configuration.account.id
  ...
  def create_folder(params = {})
    ...
    test_folder.account_id = RSpec.configuration.account.id
  ...
  def create_article(params = {})
    ...
    test_article.account_id = RSpec.configuration.account.id
    ...
    test_article.user_id = params[:user_id] || RSpec.configuration.agent.id
  ...
  def solutions_incremented? article_size
    ...
    RSpec.configuration.account.solution_articles.size.should eql article_size+1
  end
