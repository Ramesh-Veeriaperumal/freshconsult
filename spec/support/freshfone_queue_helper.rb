module FreshfoneQueueHelper
  ...
  def queue_params
    { "AccountSid"=>"AC626dc6e5b03904e6270f353f4a2f068f", "QueueSid"=>"QU629430fd5b8d41769b02abfe7bfbe3a9", 
      ...
      "Called"=>"+18433534240", "FromCountry"=>"US", "CallerCountry"=>"US", 
      ...
      "ToCity"=>"WHITE DEER", "ToState"=>"TX", "To"=>"+18433534240", "ToCountry"=>"US", 
  ...
  def dequeue_params
    { "AccountSid"=>"AC626dc6e5b03904e6270f353f4a2f068f", "QueueSid"=>"QU629430fd5b8d41769b02abfe7bfbe3a9", 
      "ToZip"=>"79097", "FromState"=>"CA", "Called"=>"+18433534240", "FromCountry"=>"US", 
      ...
      "To"=>"+18433534240", "ToCountry"=>"US", "CallerCity"=>"BAKERSFIELD", "ApiVersion"=>"2010-04-01", 
  ...
  def hangup_params
    { "AccountSid"=>"AC626dc6e5b03904e6270f353f4a2f068f", "QueueSid"=>"QU629430fd5b8d41769b02abfe7bfbe3a9", 
      ...
      "CalledState"=>"TX", "From"=>"+16617480240", "CallerZip"=>"93307", "FromZip"=>"93307", 
      "ApplicationSid"=>"APca64694c6df44b0bbcfb34058c567555", "CallStatus"=>"in-progress", 
      "ToCity"=>"WHITE DEER", "QueueResult"=>"hangup", "ToState"=>"TX", "To"=>"+18433534240", 
