module FreshfoneTransferSpecHelper
  ...
  def incoming_call_transfer_params
    { "AccountSid"=>"AC626dc6e5b03904e6270f353f4a2f068f", "CallStatus"=>"in-progress", "CalledVia"=>"+18433534240", 
      "FromState"=>"CA", "Called"=>"client:1", "To"=>"+18433534240", "ParentCallSid"=>"CAa908212d5ff226e1ce21670b41b6f6cc", 
  ...
  def outgoing_call_transfer_params
    { "AccountSid"=>"AC626dc6e5b03904e6270f353f4a2f068f", "CallStatus"=>"in-progress", "CalledVia"=>"+18433534240", 
      ...
      "FromCountry"=>"US", "CallerCountry"=>"US", "Direction"=>"outbound-dial", "CallerCity"=>"BAKERSFIELD", 
      "ApiVersion"=>"2010-04-01", "FromCity"=>"BAKERSFIELD", "ForwardedFrom"=>"+18433534240", "Caller"=>"+16617480240", 
      "CallerState"=>"CA", "CallSid"=>"CTRANSFER", "From"=>"+18433534240", "CallerZip"=>"93307", 
      "FromZip"=>"93307" }
  end
end