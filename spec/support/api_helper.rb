module APIHelper
  ...
  SOLUTION_ARTICLE_ATTRIBS = ["art_type", "created_at", "desc_un_html", "description", "folder_id", "hits", "id", "modified_at", "modified_by", "position", "seo_data", "status", "thumbs_down", "thumbs_up", "title", "updated_at", "user_id", "tags", "folder"]
