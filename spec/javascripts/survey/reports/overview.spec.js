jQuery.getScript("http://localhost:3000/packages/survey_report.jst").done(function(script){
	...
	var overview = document.createElement('script');
	overview.type = 'text/javascript';
	overview.src = 'public/javascripts/survey/reports/overview.js';
...
describe("Report overview events",function(){
	beforeEach(function(){
	...
	it("should define essential properties of survey overview",function(){
		expect(SurveyOverview).toBeDefined();
		expect(SurveyOverview.fetch).toBeDefined();
		expect(SurveyOverview.renderContent).toBeDefined();
	});

	it("should edit survey", function(){
