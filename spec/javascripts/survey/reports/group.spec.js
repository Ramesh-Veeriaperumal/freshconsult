jQuery.getScript("http://localhost:3000/packages/survey_report.jst").done(function(script){
	...
	agent.src = 'public/javascripts/survey/reports/group.js';
...
describe("Report group events",function(){
	...
	it("should define essential properties of survey report groups",function(){
		expect(SurveyGroup).toBeDefined();
		expect(SurveyGroup.change).toBeDefined();
	});

	it("should trigger change function on changing grouplist",function(){
