jQuery.getScript("http://localhost:3000/packages/survey_report.jst").done(function(script){
	...
	agent.type = 'text/javascript';
	agent.src = 'public/javascripts/survey/reports/agent.js';
...
describe("Report agent events",function(){
	beforeEach(function(){
	...
	it("should define essential properties of survey report agents",function(){
		expect(SurveyAgent).toBeDefined();
		expect(SurveyAgent.change).toBeDefined();
	});

	it("should trigger change function on changing agentlist",function(){
