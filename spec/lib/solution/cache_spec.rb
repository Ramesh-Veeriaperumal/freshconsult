...
describe Solution::Cache do
  ...
  describe "Cached data" do 
    ...
    it "should store correct data in cache" do
      cached_categories = $memcache.get(@cache_key)
  ...
  describe "Cache Invalidation" do 
    ...
    it "should clear cache when folder position changes " do
      @categories[1].folders.last.position += 1
      @categories[1].folders[3].save(validate: false)
      check_cache_invalidation    
    end
    ...
    it "should clear cache on portal solution category deletion" do
      @categories[4].portal_solution_categories.first.destroy
      check_cache_invalidation
    end
  end
