...
describe Social::FacebookPosts do
  ...
  it "should create a ticket and notes to the ticket when a company post has comments and import company post is enabled" do
    ...
    note.body.should eql comment_feed.first[:text]
  end
  
  it "should create a ticket when a visitor post arrives and import visitor post is enabled" do   
  ...
  it "should create a ticket when a post arrives and import visitor post or import company post is enabledis enabled" do   
    @fb_page.update_attributes(:import_visitor_posts => true, :import_company_posts => true)
