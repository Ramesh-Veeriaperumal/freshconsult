...
describe Admin::ContactFieldsController do
	...
	it "should create a custom field" do
		...
		cf_testimony = @account.contact_form.contact_fields.find_by_name("cf_testimony")
	...
	it "should not create custom_fields more than the available columns(boolean)" do
		...
		def custom_flexifield options = {}, tkt_flexifield = false
			...
			unless tkt_flexifield
				contact_flexifield = Factory.build(:contact_flexifield, 
				...
				ticket_flexifield = Factory.build(:flexifield, 
