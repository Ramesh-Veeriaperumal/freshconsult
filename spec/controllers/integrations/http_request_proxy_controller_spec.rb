...
describe HttpRequestProxyController do
  ...
  self.use_transactional_fixtures = false
	...
	before(:all) do
	  ...
	  @new_installed_application = FactoryGirl.build(:installed_application, {:application_id => test.id,
		...
		@shopify = FactoryGirl.build(:installed_application, {:application_id => shopify_add.id,:account_id => @account.id,
			:configs=>{:inputs=>{"refresh_token"=>"", "oauth_token"=>"fbc1ea7dd7bef91e31078f079c08dbef", "shop_name"=>"freshdesk-3.myshopify.com"}}})
		@shopify.save!

		@icontact = FactoryGirl.build(:installed_application, {:application_id => 15, :account_id => @account.id,
		...
		@survey_monkey = FactoryGirl.build(:installed_application, {:application_id => 21, :account_id => @account.id,
