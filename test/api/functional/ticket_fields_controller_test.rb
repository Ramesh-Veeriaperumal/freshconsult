...
class TicketFieldsControllerTest < ActionController::TestCase
  ...
  def test_delete_a_custom_dependent_field
    ...
    field_choices_del = [['Australia', '0',
                          [['New South Wales', '0'], %w[Queensland 0]]],
                         ['USA', '0',
                          [%w[California 0], %w[Texas 0]]]]
    picklist_vals_l1 = []
    picklist_vals_l2 = []
    picklist_vals_l3 = []
    field_choices.map(&:first).each_with_index do |l1_val, index1|
    ...
    assert_instance_of(Helpdesk::TicketField, parent_custom_field)
    refute parent_custom_field.level_three_present
  end
