...
class Ember::InstalledApplicationsControllerTest < ActionController::TestCase
  ...
  def test_freshworkscrm_fetch_contacts_fields
    ...
    param = construct_params(version: 'private', id: app_id, event: 'fetch_user_selected_fields', payload: { type: 'contact', value:{ email: 'matt.rogers@freshdesk.com' } }, format: 'json')
    post :fetch, param
    assert_response 200
  ensure
    IntegrationServices::Services::Freshworkscrm::FreshworkscrmCommonResource.any_instance.unstub(:http_get)
