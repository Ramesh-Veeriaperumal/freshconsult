  ...
  module Tickets
    class BulkActionsControllerTest < ActionController::TestCase
      ...
      def test_bulk_update_with_incorrect_values
        ...
        ticket_type_list = Account.current ? Account.current.ticket_types_from_cache.map(&:value) : []
        match_json([bad_request_error_pattern('priority', :not_included, list: '1,2,3,4'),
                    ...
                    bad_request_error_pattern('type', :not_included, list: ticket_type_list.join(','))])
        assert_response 400
      end
