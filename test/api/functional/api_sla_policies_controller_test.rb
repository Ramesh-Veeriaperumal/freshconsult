...
class ApiSlaPoliciesControllerTest < ActionController::TestCase
  ...
  def test_update_with_empty_conditions
    ...
    assert_response 400
    match_json([bad_request_error_pattern('company_ids', :datatype_mismatch, code: :missing_field, expected_data_type: Array)])
  end
  ...
  def test_update_emptying_conditions_with_blank_company_ids
    ...
    assert_response 400
    match_json([bad_request_error_pattern('applicable_to', :datatype_mismatch, expected_data_type: 'key/value pair', prepend_msg: :input_received, given_data_type: 'Null Type')])
  end
  ...
  def test_update_with_invalid_data_type
    ...
    assert_response 400
    match_json([bad_request_error_pattern('applicable_to', :datatype_mismatch, expected_data_type: 'key/value pair', prepend_msg: :input_received, given_data_type: Array)])
  end
