...
class AuditLogsControllerTest < ActionController::TestCase
  ...
  def audit_log_filter_response
    [{"time"=>1526981491586, "ip_address"=>"127. 0. 0. 1", "name"=>{"name"=>"2314211", "url_type"=>"agent", "id"=>54}, "event_performer"=>{"id"=>37, "name"=>"Admin", "url_type"=>"agent"}, "action"=>"Updated", "event_type"=>"Agent", "description"=>[{"type"=>"default", "field"=>"Email", "value"=>{"from"=>"dslads@dsadasa.com", "to"=>"dsqslads@dsadasa.com"}}, {"type"=>"default", "field"=>"Ticket Permission", "value"=>{"from"=>1, "to"=>2}}]}, {"time"=>1526980693092, "ip_address"=>nil, "name"=>{"name"=>'subscription', "url_type"=>"subscription", "id"=>6}, "event_performer"=>{"id"=>0, "name"=>"system", "url_type" => "agent"}, "action"=>"Updated", "event_type"=>"Subscription", "description"=>[{"type"=>"default", "field"=>"Agent Limit", "value"=>{"from"=>10, "to"=>9}}, {"type"=>"default", "field"=>"Subscription State", "value"=>{"from"=>"active", "to"=>"trial"}}, {"type"=>"default", "field"=>"Renewal Period", "value"=>{"from"=>1, "to"=>3}}, {"type"=>"default", "field"=>"Card Number", "value"=>{"from"=>"************1111", "to"=>"dsadadasa"}}, {"type"=>"default", "field"=>"Card Expiration", "value"=>{"from"=>"12-2019", "to"=>"2018-08-30T09:16:07Z"}}, {"type"=>"default", "field"=>"Subscription Plan", "value"=>{"from"=>5, "to"=>4}}, {"type"=>"default", "field"=>"Subscription Currency", "value"=>{"from"=>1, "to"=>2}}]}]
  end
