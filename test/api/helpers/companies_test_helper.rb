module Helpers::CompaniesTestHelper
  ...
  def company_pattern(expected_output = {}, company)
    ...
    expected_output[:ignore_updated_at] ||= true
    {
      ...
      domains: domains,
      note: company.note,
      custom_fields: CustomFieldDecorator.remove_prepended_text_from_custom_fields(expected_output['custom_field'] || company.custom_field, 3, -1),
