module FreshmarketerTestHelper
  def stub_create_account
    stubs = Faraday::Adapter::Test::Stubs.new do |stub|
      stub.post('/ab/api/v1/createsraccount') do |env|
        [200, {}, {
          status_code: 200,
          createsraccount: {
  ...
  def stub_associate_account
    stubs = Faraday::Adapter::Test::Stubs.new do |stub|
      stub.post('/ab/api/v1/associatesraccount') do |env|
        [200, {}, {
          status_code: 200,
          associatesraccount: {
            account_id: '4759555256525C455C515442425C5F5D4C5E5C5F5F',
  ...
  def stub_enable_integration
    stubs = Faraday::Adapter::Test::Stubs.new do |stub|
      stub.post('/ab/api/v1/sr/enableintegration') do |env|
        [200, {}, {
          status_code: 200,
          enableintegration: {
  ...
  def stub_disable_integration
    stubs = Faraday::Adapter::Test::Stubs.new do |stub|
      stub.post('/ab/api/v1/sr/disableintegration') do |env|
        [200, {}, {
          status_code: 200,
  ...
  def stub_cdn_script
    stubs = Faraday::Adapter::Test::Stubs.new do |stub|
      stub.get('/ab/api/v1/sr/cdnscript') do |env|
        [200, {}, {
          status_code: '200',
          cdnscript: {
            result: "<script src=\'//s3-us-west-2.amazonaws.com/zargetlab-js-bucket/48434356339/1300.js\'></script>"
  ...
  def stub_recent_sessions
    stubs = Faraday::Adapter::Test::Stubs.new do |stub|
      stub.get('/ab/api/v1/sr/sessions') do |env|
        [200, {}, {
          status: '200',
  ...
  def stub_session
    stubs = Faraday::Adapter::Test::Stubs.new do |stub|
      stub.get('/ab/api/v1/sr/session/3433444455.333334') do |env|
        [200, {}, {
          status: '200',
  ...
  def stub_experiment_details
    stubs = Faraday::Adapter::Test::Stubs.new do |stub|
      stub.get('/ab/api/v1/sr/expdetails') do |env|
        [200, {}, {
          status_code: '200',
          expdetails: {
  ...
  def stub_remove_account
    stubs = Faraday::Adapter::Test::Stubs.new do |stub|
      stub.post('/ab/api/v1/sr/removeaccount') do |env|
        [200, {}, {
          Status: 'success'
        }.to_json]
      end
