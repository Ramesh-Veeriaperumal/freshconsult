  ...
  class << self
    ...
    def choices_validatable_custom_fields
      [
        ...
        Helpers::CustomFieldValidatorTestHelper.new(id: 29, account_id: 1, name: 'dropdown_3', label: 'dropdown_3', field_type: 'custom_dropdown', position: 29, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, company_form_id: 1, required_for_agent: false),
        Helpers::CustomFieldValidatorTestHelper.new(id: 30, account_id: 1, name: 'dropdown_4', label: 'dropdown_4', label_in_portal: 'dropdown4', field_type: 'custom_dropdown', position: 30, required_for_agent: false, visible_in_portal: true, editable_in_portal: true, required_in_portal: false, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, contact_form_id: 1)
      ]
    end
    ...
    def data_type_validatable_custom_fields
      [
        ...
        Helpers::CustomFieldValidatorTestHelper.new(id: 31, account_id: 1, name: 'single_2', label: 'single_2', field_type: 'custom_text', position: 31, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, company_form_id: 1, required_for_agent: false),
        Helpers::CustomFieldValidatorTestHelper.new(id: 32, account_id: 1, name: 'single_3', label: 'single_3', label_in_portal: 'single_3', field_type: 'custom_text', position: 32, required_for_agent: false, visible_in_portal: true, editable_in_portal: true, required_in_portal: false, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, contact_form_id: 1),
        ...
        Helpers::CustomFieldValidatorTestHelper.new(id: 33, account_id: 1, name: 'check_2', label: 'check_2', field_type: 'custom_checkbox', position: 33, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, company_form_id: 1, required_for_agent: false),
        ...
        Helpers::CustomFieldValidatorTestHelper.new(id: 35, account_id: 1, name: 'decimal_3', label: 'decimal_3', field_type: 'custom_decimal', position: 35, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, company_form_id: 1, required_for_agent: false),
        Helpers::CustomFieldValidatorTestHelper.new(id: 36, account_id: 1, name: 'decimal_4', label: 'decimal_4', label_in_portal: 'decimal_4', field_type: 'custom_decimal', position: 36, required_for_agent: false, visible_in_portal: true, editable_in_portal: true, required_in_portal: false, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, contact_form_id: 1),
        ...
        Helpers::CustomFieldValidatorTestHelper.new(id: 37, account_id: 1, name: 'number_3', label: 'number_3', field_type: 'custom_number', position: 37, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, company_form_id: 1, required_for_agent: false),
        Helpers::CustomFieldValidatorTestHelper.new(id: 38, account_id: 1, name: 'number_4', label: 'number_4', label_in_portal: 'number_3', field_type: 'custom_number', position: 38, required_for_agent: false, visible_in_portal: true, editable_in_portal: true, required_in_portal: false, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, contact_form_id: 1),
        ...
        Helpers::CustomFieldValidatorTestHelper.new(id: 39, account_id: 1, name: 'multi_2', label: 'multi_2', field_type: 'custom_paragraph', position: 39, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, company_form_id: 1, required_for_agent: false),
        Helpers::CustomFieldValidatorTestHelper.new(id: 40, account_id: 1, name: 'multi_3', label: 'multi_3', label_in_portal: 'multi_3', field_type: 'custom_paragraph', position: 40, required_for_agent: false, visible_in_portal: true, editable_in_portal: true, required_in_portal: false, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, contact_form_id: 1),
        ...
        Helpers::CustomFieldValidatorTestHelper.new(id: 41, account_id: 1, name: 'phone_1', label: 'phone_1', field_type: 'custom_phone_number', position: 41, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, company_form_id: 1, required_for_agent: false),
        Helpers::CustomFieldValidatorTestHelper.new(id: 42, account_id: 1, name: 'phone_2', label: 'phone_2', label_in_portal: 'phone_2', field_type: 'custom_phone_number', position: 42, required_for_agent: false, visible_in_portal: true, editable_in_portal: true, required_in_portal: false, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, contact_form_id: 1),
        Helpers::CustomFieldValidatorTestHelper.new(id: 43, account_id: 1, name: 'url_1', label: 'url_1', field_type: 'custom_url', position: 43, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, company_form_id: 1, required_for_agent: false),
        Helpers::CustomFieldValidatorTestHelper.new(id: 44, account_id: 1, name: 'url_2', label: 'url_2', label_in_portal: 'url_2', field_type: 'custom_url', position: 44, required_for_agent: false, visible_in_portal: true, editable_in_portal: true, required_in_portal: false, created_at: '2015-08-10 09:24:39', updated_at: '2015-08-11 05:40:01', field_options: {}, contact_form_id: 1),
