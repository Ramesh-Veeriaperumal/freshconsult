...
class ApiAgentsDependencyTest < ActionView::TestCase
  def test_before_filters_agents_controller
    expected_filters = [:determine_pod, :activate_authlogic, :clean_temp_files, :select_shard, :unset_current_account,
                        :unset_current_portal, :unset_shard_for_payload, :set_current_account, :set_default_locale, :set_locale, :set_msg_id, :ensure_proper_protocol,
                        ...
                        :can_edit_roles_and_permissions, :set_selected_tab, :set_native_mobile, :set_last_active_time]
