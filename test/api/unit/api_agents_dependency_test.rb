...
class ApiAgentsDependencyTest < ActionView::TestCase
  def test_before_filters_agents_controller
    expected_filters = [:determine_pod, :activate_authlogic, :clean_temp_files, :select_shard,
      ...
      :reset_language, :set_shard_for_payload, :set_default_locale, :set_locale, :set_msg_id,
      ...
      :remove_rails_2_flash_after, :set_affiliate_cookie, :verify_authenticity_token, :load_object,
      ...
      :check_occasional_agent_params,
      :set_skill_data, :set_filter_data, :ensure_proper_sts_header, :access_denied]
