...
class MonitorValidationsTest < ActionView::TestCase
  ...
  def test_numericality_params_invalid_number
    ...
    assert_equal({ user_id: { expected_data_type: :'Positive Integer', prepend_msg: :input_received, given_data_type: String, code: :datatype_mismatch } }, monitor.error_options)
  end
