...
class ApiCommentsDependencyTest < ActionView::TestCase
  def test_before_filters_web_posts_controller
    expected_filters = [:determine_pod, :activate_authlogic, :clean_temp_files, :select_shard, :unset_current_account,
      ...
      :remove_rails_2_flash_after, :set_affiliate_cookie, :verify_authenticity_token, :find_post, :find_topic, :unset_thread_variables,
      :check_lock, :ensure_proper_sts_header, :record_query_comment]
