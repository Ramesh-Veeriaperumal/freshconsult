...
module Admin::AutomationRules::Events
  class TicketValidationTest < ActionView::TestCase
    ...
    def test_invalid_field_from_to
      ...
      event_validation = Admin::AutomationRules::Events::TicketValidation.new(params)
    ...
    def test_valid_field_value
      ...
      event_validation = Admin::AutomationRules::Events::TicketValidation.new(valid_field_value_hash)
      assert_equal true, event_validation.valid?
    ...
    def test_valid_label_field
      event_validation = Admin::AutomationRules::Events::TicketValidation.new(valid_label_type_hash)
      assert_equal true, event_validation.valid?
    end
    ...
    def test_valid_system_event_field
      event_validation = Admin::AutomationRules::Events::TicketValidation.new(valid_system_event_hash)
      assert_equal true, event_validation.valid?
    end
