...
class DraftValidationTest < ActionView::TestCase
  ...
  def test_draft_validation
    controller_params = { body: 'Sample Text', quoted_text: 'Sample Quoted Text',  cc_emails: ['AB <example@xyz.com>', 'xyz@example.com'], bcc_emails: ['<example2@xyz.com>'], from_email: 'zee@company.com', attachment_ids: [1,2] }
    draft_validation = DraftValidation.new(controller_params, nil)
