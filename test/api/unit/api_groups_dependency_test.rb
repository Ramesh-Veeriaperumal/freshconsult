...
class ApiGroupsDependencyTest < ActionView::TestCase
  def test_before_filters_application_controller
    expected_filters = [:determine_pod, :activate_authlogic, :clean_temp_files, :select_shard,
                        :unset_current_account, :unset_current_portal, :unset_shard_for_payload, :set_current_account, :reset_language, :set_default_locale, :set_locale, :set_msg_id,
                        ...
                        :verify_authenticity_token, :set_selected_tab, :set_last_active_time, :reset_language, :load_group, :filter_params,
                        :build_attributes, :set_capping_limit]
