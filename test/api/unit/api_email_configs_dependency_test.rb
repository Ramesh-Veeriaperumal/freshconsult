...
class ApiEmailConfigsDependencyTest < ActionView::TestCase
  def test_before_filters_application_controller
    expected_filters = [:determine_pod, :activate_authlogic, :clean_temp_files, :select_shard, :unset_current_account,
      ...
      :remove_rails_2_flash_after, :set_affiliate_cookie, :verify_authenticity_token, :set_selected_tab, :build_object,
      :unset_thread_variables, :load_object, :ensure_proper_sts_header, :load_imap_error_mapping, :record_query_comment]
