...
class CustomFieldValidatorTest < ActionView::TestCase
  ...
  def test_choices_validatable_fields_valid
    test = TestValidation.new(attribute1: { 'country_1' => 'Usa', ' ' => 'first11' })
    assert test.valid?
