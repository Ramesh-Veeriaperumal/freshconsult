...
class CustomFieldValidatorTest < ActionView::TestCase
  ...
  def test_nested_fields_without_required_fields
    ...
    refute test.valid?
    errors = test.errors.to_h
    assert_equal({ country_1: :required_and_inclusion, first_1: :required_and_inclusion, check2_1: :required_boolean, dropdown2_1: :required_and_inclusion, dropdown1_1: :required_and_inclusion, check1_1: :required_boolean, decimal1_1: 'required_number', decimal2_1: 'required_number', number1_1: :required_integer, number2_1: :required_integer, single1_1: :missing, multi1_1: :missing, phone1_1: :missing, dropdown3_1: :required_and_inclusion, dropdown4_1: :required_and_inclusion, check3_1: :required_boolean, check4_1: :required_boolean, decimal3_1: 'required_number', decimal4_1: 'required_number', multi2_1: :missing, multi3_1: :missing, number3_1: :required_integer, number4_1: :required_integer, phone2_1: :missing, phone3_1: :missing, single2_1: :missing, single3_1: :missing, url1_1: 'required_format', url2_1: 'required_format', date1_1: :required_date  }.sort.to_h, errors.sort.to_h)
    assert_equal({ country_1: { list: 'Usa,india' }, first_1: { list: 'category 1,category 2' },
                   ...
                   dropdown1_1: { list: '1st,2nd' }, dropdown4_1: { list: 'third,fourth' }, check1_1: { data_type: 'Boolean' }, check4_1: { data_type: 'Boolean' },
