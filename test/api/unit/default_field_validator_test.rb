...
class DefaultFieldValidatorTest < ActionView::TestCase
  ...
  def test_value_invalid
    ...
    assert_equal({ address: { max_count: 255, current_count: 555, entities: :characters }, client_manager: { expected_data_type: 'Boolean', prepend_msg: :input_received, given_data_type: String },
                   ...
                   job_title: { max_count: 255, current_count: 310, entities: :characters }, language: { list: 'en,fr,pt-BR,en-IND,sk,en-US,nep,vi,nb-NO,ru,de-AT,en-au-ocker,zh-CN,en-CA,de-CH,en-GB,ja,de,en-AU,fa,nl,pl,en-BORK,ko,it,es,sv,ar,ca,cs,da,es-LA,et,fi,he,hu,id,ja-JP,pt-PT,ro,ru-RU,sl,sv-SE,th,tr,uk,zh-TW' },
