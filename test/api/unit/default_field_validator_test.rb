...
class DefaultFieldValidatorTest < ActionView::TestCase
  ...
  def test_value_invalid
    ...
    assert_equal({ address: { max_count: 255, current_count: 555, element_type: :characters, min_count: 0 }, client_manager: { expected_data_type: 'Boolean', prepend_msg: :input_received, given_data_type: String },
                   ...
                   job_title: { max_count: 255, current_count: 310, element_type: :characters, min_count: 0 }, language: { list: I18n.available_locales.map(&:to_s).join(',') },
                   mobile: { max_count: 255, current_count: 305, element_type: :characters, min_count: 0 }, note: { expected_data_type: String, prepend_msg: :input_received, given_data_type: Integer }, phone: { max_count: 255, current_count: 306, element_type: :characters, min_count: 0 },
  ...
  def test_required_value
    ...
    assert_equal({
      source: { list: '1,2,3,5,6,7,8,9', code: :missing_field }, status: { list: '2,3,4,5', code: :missing_field }, priority: { list: '1,2,3,4', code: :missing_field }, type: { list: 'Lead,Question,Problem,Maintenance,Breakage', code: :missing_field }, group_id: {  expected_data_type: :'Positive Integer', code: :missing_field },
  ...
  def test_validator_chaining_for_email
    ...
    assert_equal({ source: {}, status: {}, priority: {}, type: {}, group_id: {}, responder_id: {}, product_id: {}, subject: {}, description: {}, email: { min_count: 0,max_count: 255, current_count: 325, element_type: :characters }, phone: {}, mobile: {}, client_manager: {}, company_id: {}, tags: {}, address: {}, job_title: {}, twitter_id: {}, language: {}, time_zone: {}, domains: {}, note: {} }, test.error_options)
  end
