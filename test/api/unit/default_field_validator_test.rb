...
class DefaultFieldValidatorTest < ActionView::TestCase
  ...
  def test_value_invalid
    ...
    assert_equal({ address: { max_count: 255, current_count: 555, element_type: :characters }, client_manager: { expected_data_type: 'Boolean', prepend_msg: :input_received, given_data_type: String },
                   ...
                   job_title: { max_count: 255, current_count: 310, element_type: :characters }, language: { list: 'en,fr,pt-BR,en-IND,sk,en-US,nep,vi,nb-NO,ru,de-AT,en-au-ocker,zh-CN,en-CA,de-CH,en-GB,ja,de,en-AU,fa,nl,pl,en-BORK,ko,it,es,sv,ar,ca,cs,da,es-LA,et,fi,he,hu,id,ja-JP,pt-PT,ro,ru-RU,sl,sv-SE,th,tr,uk,zh-TW' },
                   mobile: { max_count: 255, current_count: 305, element_type: :characters }, note: { expected_data_type: String, prepend_msg: :input_received, given_data_type: Integer }, phone: { max_count: 255, current_count: 306, element_type: :characters },
  ...
  def test_array_length_validator
    ...
    assert_equal({ source: {}, status: {}, priority: {}, type: {}, group_id: {}, responder_id: {}, product_id: {}, subject: {}, description: {}, email: {}, phone: {}, mobile: {}, client_manager: {}, company_id: {}, tags: { max_count: 32, current_count: 54, element_type: :characters }, address: {}, job_title: {}, twitter_id: {}, language: {}, time_zone: {}, domains: {}, note: {} }, test.error_options)
  end
  ...
  def test_validator_chaining_for_email
    ...
    assert_equal({ source: {}, status: {}, priority: {}, type: {}, group_id: {}, responder_id: {}, product_id: {}, subject: {}, description: {}, email: { max_count: 255, current_count: 325, element_type: :characters }, phone: {}, mobile: {}, client_manager: {}, company_id: {}, tags: {}, address: {}, job_title: {}, twitter_id: {}, language: {}, time_zone: {}, domains: {}, note: {} }, test.error_options)
  end
