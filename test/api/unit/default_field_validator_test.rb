...
class DefaultFieldValidatorTest < ActionView::TestCase
  ...
  def test_value_invalid
    ...
    assert_equal({ address: { min_count: 0,max_count: 255, current_count: 555, element_type: :characters }, client_manager: { expected_data_type: 'Boolean', prepend_msg: :input_received, given_data_type: String },
                   ...
                   job_title: { min_count: 0,max_count: 255, current_count: 310, element_type: :characters }, language: { list: I18n.available_locales.map(&:to_s).join(',') },
                   mobile: { min_count: 0,max_count: 255, current_count: 305, element_type: :characters }, note: { expected_data_type: String, prepend_msg: :input_received, given_data_type: Integer }, phone: { min_count: 0,max_count: 255, current_count: 306, element_type: :characters },
