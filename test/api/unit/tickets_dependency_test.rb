...
class TicketsDependencyTest < ActionView::TestCase
  def test_before_filters_web_tickets_controller
    expected_filters = [
      :determine_pod, :activate_authlogic, :clean_temp_files, :select_shard,
      ...
      :set_locale, :set_msg_id, :set_ui_preference, :ensure_proper_protocol, :check_privilege,
      :freshdesk_form_builder, :remove_rails_2_flash_before, :check_account_state,
      :set_time_zone, :check_day_pass_usage, :force_utf8_params, :persist_user_agent,
      :set_cache_buster, :remove_pjax_param, :set_pjax_url, :set_last_active_time,
      :reset_language, :remove_rails_2_flash_after, :set_affiliate_cookie,
      :verify_authenticity_token, :build_item, :load_multiple_items, :add_to_history,
      :redirect_to_mobile_url, :portal_check, :verify_format_and_tkt_id,
      :check_compose_feature, :check_trial_outbound_limit, :find_topic,
      :redirect_merged_topics, :run_on_slave, :save_article_filter, :run_on_db,
      :set_mobile, :normalize_params, :cache_filter_params, :load_cached_ticket_filters,
      :load_ticket_filter, :check_autorefresh_feature, :load_sort_order, :get_tag_name,
      :clear_filter, :add_requester_filter, :load_filter_params, :load_article_filter,
      :disable_notification, :enable_notification, :set_selected_tab,
      :filter_params_ids, :scoper_ticket_actions, :load_items, :set_native_mobile,
      :verify_ticket_permission_by_id, :load_ticket, :load_ticket_with_notes,
      :check_outbound_permission, :build_ticket_body_attributes, :build_ticket,
      :set_required_fields, :check_trial_customers_limit, :set_date_filter,
