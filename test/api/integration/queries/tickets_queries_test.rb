  ...
  def test_query_count
    skip_bullet do
      ...
      v2_expected = {
        ...
        update: 27,
        index: 18,
        destroy: 33, # Shoule be fixed once an alternate approach is figured out for https://github.com/freshdesk/helpkit/commit/4ce3521ff79c9864c1277013053df7dcf3af0f62
        restore: 27 # Shoule be fixed once an alternate approach is figured out for https://github.com/freshdesk/helpkit/commit/4ce3521ff79c9864c1277013053df7dcf3af0f62
      }
