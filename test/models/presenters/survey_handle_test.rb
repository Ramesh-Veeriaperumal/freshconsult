...
class SurveyHandleTest < ActiveSupport::TestCase
  ...
  def test_survey_handle_payload
    ...
    create_custom_survey_handle(@ticket)
  ...
  private
    ...
    def create_custom_survey_handle(ticket)
      SurveyHandle.create_handle_for_notification(ticket, SURVEY_SEND_WHILE_VS_TICKET_STATUS[@account.surveys.first.send_while])
    end
