...
options = { :namespace => "helpkit_#{$$}", :compress => config[:compress], :socket_max_failures => config[:socket_max_failures], :serializer => memcacheserializer }
...
custom_options = { :namespace => "helpkit_custom_#{$$}", :compress => custom_config[:compression], :socket_max_failures => custom_config[:socket_max_failures] }
