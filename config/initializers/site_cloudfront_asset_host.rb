...
CloudfrontAssetHost.configure do |config|
  config.cname = Proc.new { |source, request|
    cloudfront_cname = "static%d.freshpo.com"
    cloudfront_distribution = "d3thwd261m1b0m.cloudfront.net"
  ...
  config.exclude_pattern  = /psd|images\/sprite-images/
