ActionController::Routing::Routes.draw do |map|
  ...
  map.resource :account, :collection => { :dashboard => :get, :thanks => :get, :plans => :get, :billing => :any, :paypal => :any, :plan => :any, :payment_info => :any, :plan_paypal => :any, :cancel => :any, :canceled => :get , :signup_google => :any }
