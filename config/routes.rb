...
#  map.mobile '/mob_site', :controller => 'user_sessions', :action => 'mob_site'
  ...
  map.namespace :admin do |admin|
    ...
    admin.resources :gamification, :collection => { :toggle => :post, :quests => :get }
...
#    end
    ...
    helpdesk.resources :leaderboard, :collection => { :mini_list => :get, :user_list => :get, 
      :group_list => :get }, :only => [ :mini_list, :user_list, :group_list ]
