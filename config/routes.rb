Helpkit::Application.routes.draw do
  ...
  match '/oauth2callback' => 'authorizations#create', :as => :calender, :provider => 'google_oauth2', :via => :get
  ...
  namespace :integrations do
    ...
    match 'install/:app' => 'oauth#authenticate', :as => :oauth # rubocop:disable Rails/MatchRoute # PRE-RAILS: Need to update via
  end
  ...
  match '/signup' => 'accounts#plans', :as => :plans # rubocop:disable Rails/MatchRoute # PRE-RAILS: Need to update via
  match '/signup/d/:discount' => 'accounts#plans' # rubocop:disable Rails/MatchRoute # PRE-RAILS: Need to update via
  match '/signup/thanks' => 'accounts#thanks', :as => :thanks, via: :get
  match '/signup/create/:discount' => 'accounts#create', :as => :create, :discount => nil # rubocop:disable Rails/MatchRoute # PRE-RAILS: Need to update via
