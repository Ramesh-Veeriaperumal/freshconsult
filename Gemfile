...
gem "tnef", "1.0.2"
gem "central-publisher", git: 'git@github.com:freshdesk/central-publisher.git', tag: 'v2.0.2'
...
gem 'rule_engine', git: 'git@github.com:freshdesk/rule_engine.git', tag: 'hv0.0.6'
gem 'freshid', :git => 'git@github.com:freshdesk/freshid-ruby-client.git', :tag => 'v4.0.3'
