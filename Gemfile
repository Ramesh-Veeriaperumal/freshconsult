...
gem "tnef", "1.0.2"
gem "central-publisher", :git => 'git@github.com:freshdesk/central-publisher.git', :tag => 'v1.0.18'
...
gem 'prometheus_exporter', :git => "git@github.com:freshdesk/prometheus_exporter.git", :tag => "v1.0"
gem "ddtrace"
gem "dogstatsd-ruby"
