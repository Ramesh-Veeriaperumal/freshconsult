...
gem "tnef", "1.0.2"
gem "central-publisher", git: 'git@github.com:freshdesk/central-publisher.git', tag: 'v2.0.13'
...
gem "prometheus_exporter", :git => "git@github.com:freshdesk/prometheus_exporter.git", :tag => "v1.0.5"
gem "ddtrace"
gem "dogstatsd-ruby"
...
gem 'rule_engine', git: 'git@github.com:freshdesk/rule_engine.git', :tag => 'hv0.0.13.13'
